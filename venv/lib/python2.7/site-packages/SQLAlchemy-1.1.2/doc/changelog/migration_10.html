...
<li class="selected"><span class="link-container first"><strong>What&#8217;s New in SQLAlchemy 1.0?</strong><a class="paramlink headerlink reference internal" href="#">¶</a></span><ul>
...
<li><span class="link-container first"><a class="reference external" href="#new-session-bulk-insert-update-api">New Session Bulk INSERT/UPDATE API</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-performance-example-suite">New Performance Example Suite</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#baked-queries">&#8220;Baked&#8221; Queries</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#improvements-to-declarative-mixins-declared-attr-and-related-features">Improvements to declarative mixins, <code class="docutils literal"><span class="pre">&#64;declared_attr</span></code> and related features</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#orm-full-object-fetches-25-faster">ORM full object fetches 25% faster</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-keyedtuple-implementation-dramatically-faster">New KeyedTuple implementation dramatically faster</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#significant-improvements-in-structural-memory-use">Significant Improvements in Structural Memory Use</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#update-statements-are-now-batched-with-executemany-in-a-flush">UPDATE statements are now batched with executemany() in a flush</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#session-get-bind-handles-a-wider-variety-of-inheritance-scenarios">Session.get_bind() handles a wider variety of inheritance scenarios</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#session-get-bind-will-receive-the-mapper-in-all-relevant-query-cases">Session.get_bind() will receive the Mapper in all relevant Query cases</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#info-dictionary-improvements">.info dictionary improvements</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#columnproperty-constructs-work-a-lot-better-with-aliases-order-by">ColumnProperty constructs work a lot better with aliases, order_by</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#select-query-limit-offset-may-be-specified-as-an-arbitrary-sql-expression">Select/Query LIMIT / OFFSET may be specified as an arbitrary SQL expression</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#the-use-alter-flag-on-foreignkeyconstraint-is-usually-no-longer-needed">The <code class="docutils literal"><span class="pre">use_alter</span></code> flag on <code class="docutils literal"><span class="pre">ForeignKeyConstraint</span></code> is (usually) no longer needed</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#resultproxy-auto-close-is-now-a-soft-close">ResultProxy &#8220;auto close&#8221; is now a &#8220;soft&#8221; close</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#check-constraints-now-support-the-column-0-name-s-token-in-naming-conventions">CHECK Constraints now support the <code class="docutils literal"><span class="pre">%(column_0_name)s</span></code> token in naming conventions</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#constraints-referring-to-unattached-columns-can-auto-attach-to-the-table-when-their-referred-columns-are-attached">Constraints referring to unattached Columns can auto-attach to the Table when their referred columns are attached</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#insert-from-select-now-includes-python-and-sql-expression-defaults">INSERT FROM SELECT now includes Python and SQL-expression defaults</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#column-server-defaults-now-render-literal-values">Column server defaults now render literal values</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#uniqueconstraint-is-now-part-of-the-table-reflection-process">UniqueConstraint is now part of the Table reflection process</a></span><ul>
...
<li><span class="link-container first"><a class="reference external" href="#new-systems-to-safely-emit-parameterized-warnings">New systems to safely emit parameterized warnings</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#query-update-now-resolves-string-names-into-mapped-attribute-names">query.update() now resolves string names into mapped attribute names</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#warnings-emitted-when-comparing-objects-with-none-values-to-relationships">Warnings emitted when comparing objects with None values to relationships</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#a-negated-contains-or-equals-relationship-comparison-will-use-the-current-value-of-attributes-not-the-database-value">A &#8220;negated contains or equals&#8221; relationship comparison will use the current value of attributes, not the database value</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#changes-to-attribute-events-and-other-operations-regarding-attributes-that-have-no-pre-existing-value">Changes to attribute events and other operations regarding attributes that have no pre-existing value</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#priority-of-attribute-changes-on-relationship-bound-attributes-vs-fk-bound-may-appear-to-change">Priority of attribute changes on relationship-bound attributes vs. FK-bound may appear to change</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#session-expunge-will-fully-detach-an-object-that-s-been-deleted">session.expunge() will fully detach an object that&#8217;s been deleted</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#joined-subquery-eager-loading-explicitly-disallowed-with-yield-per">Joined/Subquery eager loading explicitly disallowed with yield_per</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#changes-and-fixes-in-handling-of-duplicate-join-targets">Changes and fixes in handling of duplicate join targets</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#deferred-columns-no-longer-implicitly-undefer">Deferred Columns No Longer Implicitly Undefer</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#deprecated-orm-event-hooks-removed">Deprecated ORM Event Hooks Removed</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#api-change-for-new-bundle-feature-when-custom-row-loaders-are-used">API Change for new Bundle feature when custom row loaders are used</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#right-inner-join-nesting-now-the-default-for-joinedload-with-innerjoin-true">Right inner join nesting now the default for joinedload with innerjoin=True</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#subqueries-no-longer-applied-to-uselist-false-joined-eager-loads">Subqueries no longer applied to uselist=False joined eager loads</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#query-update-query-delete-raises-if-used-with-join-select-from-from-self">query.update() / query.delete() raises if used with join(), select_from(), from_self()</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#query-update-with-synchronize-session-evaluate-raises-on-multi-table-update">query.update() with <code class="docutils literal"><span class="pre">synchronize_session='evaluate'</span></code> raises on multi-table update</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#resurrect-event-has-been-removed">Resurrect Event has been Removed</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#change-to-single-table-inheritance-criteria-when-using-from-self-count">Change to single-table-inheritance criteria when using from_self(), count()</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#single-table-inheritance-criteria-added-to-all-on-clauses-unconditionally">single-table-inheritance criteria added to all ON clauses unconditionally</a></span></li>
</ul>
</li>
<li><span class="link-container first"><a class="reference external" href="#key-behavioral-changes-core">Key Behavioral Changes - Core</a></span><ul>
<li><span class="link-container first"><a class="reference external" href="#warnings-emitted-when-coercing-full-sql-fragments-into-text">Warnings emitted when coercing full SQL fragments into text()</a></span><ul>
<li><span class="link-container first"><a class="reference external" href="#order-by-and-group-by-are-special-cases">ORDER BY and GROUP BY are special cases</a></span></li>
</ul>
</li>
<li><span class="link-container first"><a class="reference external" href="#python-side-defaults-invoked-for-each-row-invidually-when-using-a-multivalued-insert">Python-side defaults invoked for each row invidually when using a multivalued insert</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#event-listeners-can-not-be-added-or-removed-from-within-that-event-s-runner">Event listeners can not be added or removed from within that event&#8217;s runner</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#the-insert-from-select-construct-now-implies-inline-true">The INSERT...FROM SELECT construct now implies <code class="docutils literal"><span class="pre">inline=True</span></code></a></span></li>
<li><span class="link-container first"><a class="reference external" href="#autoload-with-now-implies-autoload-true"><code class="docutils literal"><span class="pre">autoload_with</span></code> now implies <code class="docutils literal"><span class="pre">autoload=True</span></code></a></span></li>
<li><span class="link-container first"><a class="reference external" href="#dbapi-exception-wrapping-and-handle-error-event-improvements">DBAPI exception wrapping and handle_error() event improvements</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#foreignkeyconstraint-columns-is-now-a-columncollection">ForeignKeyConstraint.columns is now a ColumnCollection</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#metadata-sorted-tables-accessor-is-deterministic">MetaData.sorted_tables accessor is &#8220;deterministic&#8221;</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#null-false-and-true-constants-are-no-longer-singletons">null(), false() and true() constants are no longer singletons</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#sqlite-oracle-have-distinct-methods-for-temporary-table-view-name-reporting">SQLite/Oracle have distinct methods for temporary table/view name reporting</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#overhaul-of-enum-type-create-drop-rules">Overhaul of ENUM type create/drop rules</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-postgresql-table-options">New PostgreSQL Table options</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-get-enums-method-with-postgresql-dialect">New get_enums() method with PostgreSQL Dialect</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#postgresql-dialect-reflects-materialized-views-foreign-tables">PostgreSQL Dialect reflects Materialized Views, Foreign Tables</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#postgresql-has-table-now-works-for-temporary-tables">PostgreSQL <code class="docutils literal"><span class="pre">has_table()</span></code> now works for temporary tables</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#postgresql-filter-keyword">PostgreSQL FILTER keyword</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#pg8000-dialect-supports-client-side-encoding">PG8000 dialect supports client side encoding</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#pg8000-native-jsonb-support">PG8000 native JSONB support</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-psycopg2cffi-dialect-on-pypy">Support for psycopg2cffi Dialect on Pypy</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#mysql-timestamp-type-now-renders-null-not-null-in-all-cases">MySQL TIMESTAMP Type now renders NULL / NOT NULL in all cases</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#mysql-set-type-overhauled-to-support-empty-sets-unicode-blank-value-handling">MySQL SET Type Overhauled to support empty sets, unicode, blank value handling</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#mysql-internal-no-such-table-exceptions-not-passed-to-event-handlers">MySQL internal &#8220;no such table&#8221; exceptions not passed to event handlers</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#changed-the-default-value-of-raise-on-warnings-for-mysql-connector">Changed the default value of <code class="docutils literal"><span class="pre">raise_on_warnings</span></code> for MySQL-Connector</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#mysql-boolean-symbols-true-false-work-again">MySQL boolean symbols &#8220;true&#8221;, &#8220;false&#8221; work again</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#the-match-operator-now-returns-an-agnostic-matchtype-compatible-with-mysql-s-floating-point-return-value">The match() operator now returns an agnostic MatchType compatible with MySQL&#8217;s floating point return value</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#drizzle-dialect-is-now-an-external-dialect">Drizzle Dialect is now an External Dialect</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#sqlite-named-and-unnamed-unique-and-foreign-key-constraints-will-inspect-and-reflect">SQLite named and unnamed UNIQUE and FOREIGN KEY constraints will inspect and reflect</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#pyodbc-driver-name-is-required-with-hostname-based-sql-server-connections">PyODBC driver name is required with hostname-based SQL Server connections</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#sql-server-2012-large-text-binary-types-render-as-varchar-nvarchar-varbinary">SQL Server 2012 large text / binary types render as VARCHAR, NVARCHAR, VARBINARY</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#improved-support-for-ctes-in-oracle">Improved support for CTEs in Oracle</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-oracle-keywords-for-ddl">New Oracle Keywords for DDL</a></span></li>
</ul>
</li>
</ul>
</li>
...
<p class="last">Document last updated: June 9, 2015</p>
</div>
...
<p>A new series of <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a> methods which provide hooks directly
...
<p class="last"><a class="reference internal" href="../orm/persistence_techniques.html#bulk-operations"><span class="std std-ref">Bulk Operations</span></a> - introduction and full documentation</p>
</div>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/examples.html#examples-performance"><span class="std std-ref">Performance</span></a></p>
</div>
</div>
...
straightforward construction an invocation of <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> objects
using caching, which upon successive calls features vastly reduced
Python function call overhead (over 75%).    By  specifying a
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object as a series of lambdas which are only invoked
once, a query as a pre-compiled unit begins to be feasible:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.ext</span> <span class="k">import</span> <span class="n">baked</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/extensions/baked.html"><span class="std std-ref">Baked Queries</span></a></p>
</div>
...
<span id="feature-3150"></span><h3>Improvements to declarative mixins, <code class="docutils literal"><span class="pre">&#64;declared_attr</span></code> and related features<a class="headerlink" href="#improvements-to-declarative-mixins-declared-attr-and-related-features" title="Permalink to this headline">¶</a></h3>
<p>The declarative system in conjunction with <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> has been
overhauled to support new capabilities.</p>
<p>A function decorated with <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> is now called only <strong>after</strong>
...
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> object:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">HasFooBar</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
...
<p>Above, <code class="docutils literal"><span class="pre">SomeClass.foobar_prop</span></code> will be invoked against <code class="docutils literal"><span class="pre">SomeClass</span></code>,
and <code class="docutils literal"><span class="pre">SomeClass.foobar</span></code> will be the final <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> object that is
to be mapped to <code class="docutils literal"><span class="pre">SomeClass</span></code>, as opposed to the non-copied object present
directly on <code class="docutils literal"><span class="pre">HasFooBar</span></code>, even though the columns aren&#8217;t mapped yet.</p>
<p>The <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> function now <strong>memoizes</strong> the value
...
<p>Previously, <code class="docutils literal"><span class="pre">SomeClass</span></code> would be mapped with one particular copy of
the <code class="docutils literal"><span class="pre">foobar</span></code> column, but the <code class="docutils literal"><span class="pre">foobar_prop</span></code> by calling upon <code class="docutils literal"><span class="pre">foobar</span></code>
a second time would produce a different column.   The value of
<code class="docutils literal"><span class="pre">SomeClass.foobar</span></code> is now memoized during declarative setup time, so that
...
<a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> is called upon.</p>
...
the <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> function is called upon from other
<a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr" title="sqlalchemy.ext.declarative.declared_attr"><code class="xref py py-class docutils literal"><span class="pre">declared_attr</span></code></a> functions locally present before the class is
actually mapped.</p>
...
<a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr.cascading" title="sqlalchemy.ext.declarative.declared_attr.cascading"><code class="xref py py-attr docutils literal"><span class="pre">declared_attr.cascading</span></code></a> is added.  With this modifier, the
...
special attributes such as <code class="docutils literal"><span class="pre">__table_args__</span></code> and <code class="docutils literal"><span class="pre">__mapper_args__</span></code>,
...
With <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.declared_attr.cascading" title="sqlalchemy.ext.declarative.declared_attr.cascading"><code class="xref py py-attr docutils literal"><span class="pre">declared_attr.cascading</span></code></a>, individual behaviors can be
applied:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">HasIdMixin</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/extensions/declarative/mixins.html#mixin-inheritance-columns"><span class="std std-ref">Mixing in Columns in Inheritance Scenarios</span></a></p>
</div>
<p>Finally, the <a class="reference internal" href="../orm/extensions/declarative/api.html#sqlalchemy.ext.declarative.AbstractConcreteBase" title="sqlalchemy.ext.declarative.AbstractConcreteBase"><code class="xref py py-class docutils literal"><span class="pre">AbstractConcreteBase</span></code></a> class has been reworked
so that a relationship or other mapper property can be set up inline
on the abstract base:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Column</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">ForeignKey</span>
...
<p>The above mapping will set up a table <code class="docutils literal"><span class="pre">cca</span></code> with both an <code class="docutils literal"><span class="pre">id</span></code> and
a <code class="docutils literal"><span class="pre">something_id</span></code> column, and <code class="docutils literal"><span class="pre">Concrete</span></code> will also have a relationship
<code class="docutils literal"><span class="pre">something</span></code>.  The new feature is that <code class="docutils literal"><span class="pre">Abstract</span></code> will also have an
independently configured relationship <code class="docutils literal"><span class="pre">something</span></code> that builds against
...
<p>The mechanics of the <code class="docutils literal"><span class="pre">loading.py</span></code> module as well as the identity map
...
1.0.  The <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.yield_per" title="sqlalchemy.orm.query.Query.yield_per"><code class="xref py py-meth docutils literal"><span class="pre">Query.yield_per()</span></code></a> call is always a good idea when batching
...
at once.  Without the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.yield_per" title="sqlalchemy.orm.query.Query.yield_per"><code class="xref py py-meth docutils literal"><span class="pre">Query.yield_per()</span></code></a>, the above script on the
...
<p>We took a look into the <a class="reference internal" href="../orm/query.html#sqlalchemy.util.KeyedTuple" title="sqlalchemy.util.KeyedTuple"><code class="xref py py-class docutils literal"><span class="pre">KeyedTuple</span></code></a> implementation in the hopes
of improving queries like this:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">rows</span> <span class="o">=</span> <span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Foo</span><span class="o">.</span><span class="n">a</span><span class="p">,</span> <span class="n">Foo</span><span class="o">.</span><span class="n">b</span><span class="p">,</span> <span class="n">Foo</span><span class="o">.</span><span class="n">c</span><span class="p">)</span><span class="o">.</span><span class="n">all</span><span class="p">()</span></pre></div>
</div>
<p>The <a class="reference internal" href="../orm/query.html#sqlalchemy.util.KeyedTuple" title="sqlalchemy.util.KeyedTuple"><code class="xref py py-class docutils literal"><span class="pre">KeyedTuple</span></code></a> class is used rather than Python&#8217;s
<code class="docutils literal"><span class="pre">collections.namedtuple()</span></code>, because the latter has a very complex
type-creation routine that benchmarks much slower than <a class="reference internal" href="../orm/query.html#sqlalchemy.util.KeyedTuple" title="sqlalchemy.util.KeyedTuple"><code class="xref py py-class docutils literal"><span class="pre">KeyedTuple</span></code></a>.
However, when fetching hundreds of thousands of rows,
<code class="docutils literal"><span class="pre">collections.namedtuple()</span></code> quickly overtakes <a class="reference internal" href="../orm/query.html#sqlalchemy.util.KeyedTuple" title="sqlalchemy.util.KeyedTuple"><code class="xref py py-class docutils literal"><span class="pre">KeyedTuple</span></code></a> which
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># reported by heapy, summation of SQLAlchemy objects +</span>
...
<li>The mapping does not use a <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.params.version_id_col" title="sqlalchemy.orm.mapper"><code class="xref py py-paramref docutils literal"><span class="pre">version_id_col</span></code></a>, or
...
<p>The <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.get_bind" title="sqlalchemy.orm.session.Session.get_bind"><code class="xref py py-meth docutils literal"><span class="pre">Session.get_bind()</span></code></a> method is invoked whenever a query or unit
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">MyClass</span><span class="p">(</span><span class="n">SomeMixin</span><span class="p">,</span> <span class="n">Base</span><span class="p">):</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">BaseClass</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
...
<p>A series of issues were repaired where the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.get_bind" title="sqlalchemy.orm.session.Session.get_bind"><code class="xref py py-meth docutils literal"><span class="pre">Session.get_bind()</span></code></a>
would not receive the primary <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal"><span class="pre">Mapper</span></code></a> of the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a>,
...
a <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object).</p>
<p>The <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal"><span class="pre">Mapper</span></code></a> object, when passed to <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.get_bind" title="sqlalchemy.orm.session.Session.get_bind"><code class="xref py py-meth docutils literal"><span class="pre">Session.get_bind()</span></code></a>,
is typically used by sessions that make use of the
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.params.binds" title="sqlalchemy.orm.session.Session"><code class="xref py py-paramref docutils literal"><span class="pre">Session.binds</span></code></a> parameter to associate mappers with a
...
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.get_bind" title="sqlalchemy.orm.session.Session.get_bind"><code class="xref py py-meth docutils literal"><span class="pre">Session.get_bind()</span></code></a> method that provies some pattern of
...
<ul>
<li><p class="first"><a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.count" title="sqlalchemy.orm.query.Query.count"><code class="xref py py-meth docutils literal"><span class="pre">Query.count()</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">count</span><span class="p">()</span></pre></div>
</div>
</li>
<li><p class="first"><a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal"><span class="pre">Query.update()</span></code></a> and <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.delete" title="sqlalchemy.orm.query.Query.delete"><code class="xref py py-meth docutils literal"><span class="pre">Query.delete()</span></code></a>, both for the UPDATE/DELETE
statement as well as for the SELECT used by the &#8220;fetch&#8221; strategy:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">id</span> <span class="o">==</span> <span class="mi">15</span><span class="p">)</span><span class="o">.</span><span class="n">update</span><span class="p">(</span>
...
<li><p class="first">Queries against individual columns:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">User</span><span class="o">.</span><span class="n">name</span><span class="p">)</span><span class="o">.</span><span class="n">all</span><span class="p">()</span></pre></div>
</div>
</li>
<li><p class="first">SQL functions and other expressions against indirect mappings such as
<a class="reference internal" href="../orm/mapping_columns.html#sqlalchemy.orm.column_property" title="sqlalchemy.orm.column_property"><code class="xref py py-obj docutils literal"><span class="pre">column_property</span></code></a>:</p>
...
<p>The <code class="xref py py-attr docutils literal"><span class="pre">InspectionAttr.info</span></code> collection is now available on every kind
of object that one would retrieve from the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper.all_orm_descriptors" title="sqlalchemy.orm.mapper.Mapper.all_orm_descriptors"><code class="xref py py-attr docutils literal"><span class="pre">Mapper.all_orm_descriptors</span></code></a>
collection.  This includes <a class="reference internal" href="../orm/extensions/hybrid.html#sqlalchemy.ext.hybrid.hybrid_property" title="sqlalchemy.ext.hybrid.hybrid_property"><code class="xref py py-class docutils literal"><span class="pre">hybrid_property</span></code></a> and <a class="reference internal" href="../orm/extensions/associationproxy.html#sqlalchemy.ext.associationproxy.association_proxy" title="sqlalchemy.ext.associationproxy.association_proxy"><code class="xref py py-func docutils literal"><span class="pre">association_proxy()</span></code></a>.
...
<a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper.all_orm_descriptors" title="sqlalchemy.orm.mapper.Mapper.all_orm_descriptors"><code class="xref py py-attr docutils literal"><span class="pre">Mapper.all_orm_descriptors</span></code></a> namespace:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">SomeObject</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    <span class="c1"># ...</span>
...
<p>It is also available as a constructor argument for all <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal"><span class="pre">SchemaItem</span></code></a>
objects (e.g. <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal"><span class="pre">ForeignKey</span></code></a>, <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a> etc.) as well
as remaining ORM constructs such as <a class="reference internal" href="../orm/mapped_attributes.html#sqlalchemy.orm.synonym" title="sqlalchemy.orm.synonym"><code class="xref py py-func docutils literal"><span class="pre">orm.synonym()</span></code></a>.</p>
...
<p>A variety of issues regarding <a class="reference internal" href="../orm/mapping_columns.html#sqlalchemy.orm.column_property" title="sqlalchemy.orm.column_property"><code class="xref py py-func docutils literal"><span class="pre">column_property()</span></code></a> have been fixed,
most specifically with regards to the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.aliased" title="sqlalchemy.orm.aliased"><code class="xref py py-func docutils literal"><span class="pre">aliased()</span></code></a> construct as well
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="p">(</span><span class="n">SELECT</span> <span class="nb">max</span><span class="p">(</span><span class="n">b</span><span class="o">.</span><span class="n">id</span><span class="p">)</span> <span class="n">AS</span> <span class="n">max_1</span> <span class="n">FROM</span> <span class="n">b</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="n">a</span><span class="o">.</span><span class="n">type</span> <span class="n">AS</span> <span class="n">a_type</span><span class="p">,</span> <span class="p">(</span><span class="n">SELECT</span> <span class="nb">max</span><span class="p">(</span><span class="n">b</span><span class="o">.</span><span class="n">id</span><span class="p">)</span> <span class="n">AS</span> <span class="n">max_1</span>
...
the state of an <code class="docutils literal"><span class="pre">aliased()</span></code> construct such that the labeling logic
...
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object also passes through any expression to the underlying
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select" title="sqlalchemy.sql.expression.Select"><code class="xref py py-class docutils literal"><span class="pre">Select</span></code></a> object.   Typically
this is used to allow a bound parameter to be passed, which can be substituted
with a value later:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">sel</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="n">table</span><span class="p">])</span><span class="o">.</span><span class="n">limit</span><span class="p">(</span><span class="n">bindparam</span><span class="p">(</span><span class="s1">&#39;mylimit&#39;</span><span class="p">))</span><span class="o">.</span><span class="n">offset</span><span class="p">(</span><span class="n">bindparam</span><span class="p">(</span><span class="s1">&#39;myoffset&#39;</span><span class="p">))</span></pre></div>
</div>
...
uses the <code class="docutils literal"><span class="pre">._limit</span></code> or <code class="docutils literal"><span class="pre">._offset</span></code> attributes will continue to function
...
instead raise a <a class="reference internal" href="../core/exceptions.html#sqlalchemy.exc.CompileError" title="sqlalchemy.exc.CompileError"><code class="xref py py-class docutils literal"><span class="pre">CompileError</span></code></a> on access.  A third-party dialect which
wishes to support the new feature should now call upon the <code class="docutils literal"><span class="pre">._limit_clause</span></code>
and <code class="docutils literal"><span class="pre">._offset_clause</span></code> attributes to receive the full SQL expression, rather
than the integer value.</p>
</div>
<div class="section" id="the-use-alter-flag-on-foreignkeyconstraint-is-usually-no-longer-needed">
<span id="feature-3282"></span><h3>The <code class="docutils literal"><span class="pre">use_alter</span></code> flag on <code class="docutils literal"><span class="pre">ForeignKeyConstraint</span></code> is (usually) no longer needed<a class="headerlink" href="#the-use-alter-flag-on-foreignkeyconstraint-is-usually-no-longer-needed" title="Permalink to this headline">¶</a></h3>
<p>The <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData.create_all" title="sqlalchemy.schema.MetaData.create_all"><code class="xref py py-meth docutils literal"><span class="pre">MetaData.create_all()</span></code></a> and <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData.drop_all" title="sqlalchemy.schema.MetaData.drop_all"><code class="xref py py-meth docutils literal"><span class="pre">MetaData.drop_all()</span></code></a> methods will
...
need to specify <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint.params.use_alter" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-paramref docutils literal"><span class="pre">ForeignKeyConstraint.use_alter</span></code></a>.   Additionally,
...
<p>The <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint.params.use_alter" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-paramref docutils literal"><span class="pre">ForeignKeyConstraint.use_alter</span></code></a> and
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKey.params.use_alter" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-paramref docutils literal"><span class="pre">ForeignKey.use_alter</span></code></a> flags remain in place, and continue to have
...
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal"><span class="pre">ForeignKey</span></code></a> and <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">ForeignKeyConstraint</span></code></a> objects which should
be explicitly omitted from the sort.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../core/constraints.html#use-alter"><span class="std std-ref">Creating/Dropping Foreign Key Constraints via ALTER</span></a> - full description of the new behavior.</p>
</div>
...
<p>For many releases, the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal"><span class="pre">ResultProxy</span></code></a> object has always been
...
upon <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy.close()</span></code></a> explicitly; as all DBAPI resources had been
...
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy.fetchone" title="sqlalchemy.engine.ResultProxy.fetchone"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy.fetchone()</span></code></a>, <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy.fetchmany" title="sqlalchemy.engine.ResultProxy.fetchmany"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy.fetchmany()</span></code></a> or
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy.fetchall" title="sqlalchemy.engine.ResultProxy.fetchall"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy.fetchall()</span></code></a> would now raise a <a class="reference internal" href="../core/exceptions.html#sqlalchemy.exc.ResourceClosedError" title="sqlalchemy.exc.ResourceClosedError"><code class="xref py py-class docutils literal"><span class="pre">ResourceClosedError</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">result</span> <span class="o">=</span> <span class="n">connection</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">stmt</span><span class="p">)</span>
...
result proxy, such as the <code class="xref py py-class docutils literal"><span class="pre">BufferedColumnResultProxy</span></code> used by the
cx_oracle dialect for certain datatypes.</p>
<p>To solve this, the &#8220;closed&#8221; state of the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal"><span class="pre">ResultProxy</span></code></a> has been
...
establishing the fetch methods as &#8220;closed&#8221;.   The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy.close()</span></code></a>
method is now never called implicitly, only the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy._soft_close" title="sqlalchemy.engine.ResultProxy._soft_close"><code class="xref py py-meth docutils literal"><span class="pre">ResultProxy._soft_close()</span></code></a>
...
<h3>CHECK Constraints now support the <code class="docutils literal"><span class="pre">%(column_0_name)s</span></code> token in naming conventions<a class="headerlink" href="#check-constraints-now-support-the-column-0-name-s-token-in-naming-conventions" title="Permalink to this headline">¶</a></h3>
<p>The <code class="docutils literal"><span class="pre">%(column_0_name)s</span></code> will derive from the first column found in the
expression of a <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.CheckConstraint" title="sqlalchemy.schema.CheckConstraint"><code class="xref py py-class docutils literal"><span class="pre">CheckConstraint</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">metadata</span> <span class="o">=</span> <span class="n">MetaData</span><span class="p">(</span>
...
<p>Will render:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">foo</span> <span class="p">(</span>
...
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.SchemaType" title="sqlalchemy.types.SchemaType"><code class="xref py py-class docutils literal"><span class="pre">SchemaType</span></code></a> such as <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Boolean" title="sqlalchemy.types.Boolean"><code class="xref py py-class docutils literal"><span class="pre">Boolean</span></code></a> or <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal"><span class="pre">Enum</span></code></a> will also
...
<p class="last"><a class="reference internal" href="../core/constraints.html#naming-schematypes"><span class="std std-ref">Configuring Naming for Boolean, Enum, and other schema types</span></a></p>
</div>
...
<p>Since at least version 0.8, a <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal"><span class="pre">Constraint</span></code></a> has had the ability to
&#8220;auto-attach&#8221; itself to a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> based on being passed table-attached columns:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">UniqueConstraint</span>
...
this same auto-attachment logic can now function even if the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a>
objects are not yet associated with the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a>; additional events
are established such that when those <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> objects are associated,
the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal"><span class="pre">Constraint</span></code></a> is also added:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">UniqueConstraint</span>
...
does not occur if the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal"><span class="pre">Constraint</span></code></a> refers to a mixture of
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> objects and string column names; as we do not yet have
tracking for the addition of names to a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">UniqueConstraint</span>
...
column &#8220;b&#8221; is attached (as &#8220;a&#8221; is stated in the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> constructor
...
<p>The original auto-attach logic of course remains in place, if the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a>
already contains all the target <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> objects at the time
the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal"><span class="pre">Constraint</span></code></a> is constructed:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">UniqueConstraint</span>
...
<p><a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert.from_select" title="sqlalchemy.sql.expression.Insert.from_select"><code class="xref py py-meth docutils literal"><span class="pre">Insert.from_select()</span></code></a> now includes Python and SQL-expression defaults if
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">select</span><span class="p">,</span> <span class="n">func</span>
...
<p>Will render:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">INSERT</span> <span class="n">INTO</span> <span class="n">t</span> <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">)</span> <span class="n">SELECT</span> <span class="n">t</span><span class="o">.</span><span class="n">x</span><span class="p">,</span> <span class="n">somefunction</span><span class="p">()</span> <span class="n">AS</span> <span class="n">somefunction_1</span>
<span class="n">FROM</span> <span class="n">t</span></pre></div>
</div>
<p>The feature can be disabled using
<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert.from_select.params.include_defaults" title="sqlalchemy.sql.expression.Insert.from_select"><code class="xref py py-paramref docutils literal"><span class="pre">Insert.from_select.include_defaults</span></code></a>.</p>
</div>
...
<a class="reference internal" href="../core/defaults.html#sqlalchemy.schema.DefaultClause" title="sqlalchemy.schema.DefaultClause"><code class="xref py py-class docutils literal"><span class="pre">DefaultClause</span></code></a>, set up by <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.server_default" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal"><span class="pre">Column.server_default</span></code></a>
is present as a SQL expression to be compiled.  This allows literals
embedded in SQL to render correctly, such as:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Text</span>
...
<p>Now renders:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">derp</span> <span class="p">(</span>
...
<p>Previously, the literal values <code class="docutils literal"><span class="pre">&quot;foo&quot;,</span> <span class="pre">&quot;bar&quot;,</span> <span class="pre">&quot;baz&quot;</span></code> would render as
...
<p>A <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> object populated using <code class="docutils literal"><span class="pre">autoload=True</span></code> will now
include <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a> constructs as well as
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal"><span class="pre">Index</span></code></a> constructs.  This logic has a few caveats for
...
constraint as well. The <a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_indexes" title="sqlalchemy.engine.reflection.Inspector.get_indexes"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_indexes()</span></code></a> and the
<a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_unique_constraints" title="sqlalchemy.engine.reflection.Inspector.get_unique_constraints"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_unique_constraints()</span></code></a> methods will continue to
<strong>both</strong> return these entries distinctly, where
<a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_indexes" title="sqlalchemy.engine.reflection.Inspector.get_indexes"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_indexes()</span></code></a> now features a token
<code class="docutils literal"><span class="pre">duplicates_constraint</span></code> within the index entry  indicating the
corresponding constraint when detected.   However, when performing
full table reflection using  <code class="docutils literal"><span class="pre">Table(...,</span> <span class="pre">autoload=True)</span></code>, the
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal"><span class="pre">Index</span></code></a> construct is detected as being linked to the
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a>, and is <strong>not</strong> present within the
<code class="xref py py-attr docutils literal"><span class="pre">Table.indexes</span></code> collection; only the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a>
will be present in the <code class="xref py py-attr docutils literal"><span class="pre">Table.constraints</span></code> collection.   This
deduplication logic works by joining to the <code class="docutils literal"><span class="pre">pg_constraint</span></code> table
when querying <code class="docutils literal"><span class="pre">pg_index</span></code> to see if the two constructs are linked.</p>
</div>
...
<a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_indexes" title="sqlalchemy.engine.reflection.Inspector.get_indexes"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_indexes()</span></code></a>
and the <a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_unique_constraints" title="sqlalchemy.engine.reflection.Inspector.get_unique_constraints"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_unique_constraints()</span></code></a> methods will continue to
<strong>both</strong> return an entry for a UNIQUE index in MySQL,
where <a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_unique_constraints" title="sqlalchemy.engine.reflection.Inspector.get_unique_constraints"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_unique_constraints()</span></code></a> features a new token
<code class="docutils literal"><span class="pre">duplicates_index</span></code> within the constraint entry indicating that this is a
dupe entry corresponding to that index.  However, when performing
full table reflection using <code class="docutils literal"><span class="pre">Table(...,</span> <span class="pre">autoload=True)</span></code>,
the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a> construct is
<strong>not</strong> part of the fully reflected <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> construct under any
circumstances; this construct is always represented by a <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal"><span class="pre">Index</span></code></a>
with the <code class="docutils literal"><span class="pre">unique=True</span></code> setting present in the <code class="xref py py-attr docutils literal"><span class="pre">Table.indexes</span></code>
collection.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
...
<p class="last"><a class="reference internal" href="../dialects/mysql.html#mysql-unique-constraints"><span class="std std-ref">MySQL Unique Constraints and Reflection</span></a></p>
</div>
...
<code class="docutils literal"><span class="pre">Unicode</span> <span class="pre">type</span> <span class="pre">received</span> <span class="pre">non-unicode</span> <span class="pre">bind</span> <span class="pre">param</span> <span class="pre">value</span></code> warning.  Placing
the data value in this message would mean that the Python <code class="docutils literal"><span class="pre">__warningregistry__</span></code>
for that module, or in some cases the Python-global <code class="docutils literal"><span class="pre">warnings.onceregistry</span></code>,
...
<p>The change here is that by using a special <code class="docutils literal"><span class="pre">string</span></code> type that purposely
...
values, such that a warning such as <code class="docutils literal"><span class="pre">Unicode</span> <span class="pre">type</span> <span class="pre">received</span> <span class="pre">non-unicode</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">create_engine</span><span class="p">,</span> <span class="n">Unicode</span><span class="p">,</span> <span class="n">select</span><span class="p">,</span> <span class="n">cast</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">lib</span><span class="o">/</span><span class="n">sqlalchemy</span><span class="o">/</span><span class="n">sql</span><span class="o">/</span><span class="n">sqltypes</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">186</span><span class="p">:</span> <span class="n">SAWarning</span><span class="p">:</span> <span class="n">Unicode</span> <span class="nb">type</span> <span class="n">received</span>
...
<p>The documentation for <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal"><span class="pre">Query.update()</span></code></a> states that the given
<code class="docutils literal"><span class="pre">values</span></code> dictionary is &#8220;a dictionary with attributes names as keys&#8221;,
...
<p>Above, the column <code class="docutils literal"><span class="pre">user_name</span></code> is mapped as <code class="docutils literal"><span class="pre">name</span></code>.  Previously,
a call to <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal"><span class="pre">Query.update()</span></code></a> that was passed strings would have to
have been called as follows:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">update</span><span class="p">({</span><span class="s1">&#39;user_name&#39;</span><span class="p">:</span> <span class="s1">&#39;moonbeam&#39;</span><span class="p">})</span></pre></div>
</div>
<p>The given string is now resolved against the entity:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">update</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;moonbeam&#39;</span><span class="p">})</span></pre></div>
</div>
<p>It is typically preferable to use the attribute directly, to avoid any
ambiguity:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">update</span><span class="p">({</span><span class="n">User</span><span class="o">.</span><span class="n">name</span><span class="p">:</span> <span class="s1">&#39;moonbeam&#39;</span><span class="p">})</span></pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Address</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">Address</span><span class="o">.</span><span class="n">user</span> <span class="o">==</span> <span class="n">User</span><span class="p">(</span><span class="nb">id</span><span class="o">=</span><span class="kc">None</span><span class="p">))</span></pre></div>
</div>
<p>This pattern is not currently supported in SQLAlchemy.  For all versions,
it emits SQL resembling:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>SELECT address.id AS address_id, address.user_id AS address_user_id,
address.email_address AS address_email_address
FROM address WHERE ? = address.user_id
(None,)</pre></div>
</div>
<p>Note above, there is a comparison <code class="docutils literal"><span class="pre">WHERE</span> <span class="pre">?</span> <span class="pre">=</span> <span class="pre">address.user_id</span></code> where the
bound value <code class="docutils literal"><span class="pre">?</span></code> is receiving <code class="docutils literal"><span class="pre">None</span></code>, or <code class="docutils literal"><span class="pre">NULL</span></code> in SQL.  <strong>This will
always return False in SQL</strong>.  The comparison here would in theory
generate SQL as follows:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">address</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">address_id</span><span class="p">,</span> <span class="n">address</span><span class="o">.</span><span class="n">user_id</span> <span class="n">AS</span> <span class="n">address_user_id</span><span class="p">,</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SAWarning</span><span class="p">:</span> <span class="n">Got</span> <span class="kc">None</span> <span class="k">for</span> <span class="n">value</span> <span class="n">of</span> <span class="n">column</span> <span class="n">user</span><span class="o">.</span><span class="n">id</span><span class="p">;</span> <span class="n">this</span> <span class="ow">is</span> <span class="n">unsupported</span>
...
all of the betas; a value like <code class="docutils literal"><span class="pre">SYMBOL('NEVER_SET')</span></code> would be generated.
...
<p>Given <code class="docutils literal"><span class="pre">A</span></code>, with primary key of 7, but which we changed to be 10
without flushing:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">s</span> <span class="o">=</span> <span class="n">Session</span><span class="p">(</span><span class="n">autoflush</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">B</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">B</span><span class="o">.</span><span class="n">a</span> <span class="o">==</span> <span class="n">a1</span><span class="p">)</span></pre></div>
</div>
<p>Produces:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>SELECT b.id AS b_id, b.a_id AS b_a_id
FROM b
WHERE ? = b.a_id
(10,)</pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">b</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">b</span><span class="o">.</span><span class="n">a_id</span>
...
<span class="p">{</span><span class="s1">u&#39;a_id_1&#39;</span><span class="p">:</span> <span class="n">symbol</span><span class="p">(</span><span class="s1">&#39;NEVER_SET&#39;</span><span class="p">)}</span></pre></div>
</div>
<p>This inconsistency has been repaired, and in all queries the current attribute
value, in this example <code class="docutils literal"><span class="pre">10</span></code>, will now be used.</p>
...
<p>In this change, the default return value of <code class="docutils literal"><span class="pre">None</span></code> when accessing an object
...
The visible result of this change is that <code class="docutils literal"><span class="pre">obj.__dict__</span></code> is not implicitly
modified on get, and there are also some minor behavioral changes
for <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.attributes.get_history" title="sqlalchemy.orm.attributes.get_history"><code class="xref py py-func docutils literal"><span class="pre">attributes.get_history()</span></code></a> and related functions.</p>
<p>Given an object with no state:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">obj</span> <span class="o">=</span> <span class="n">Foo</span><span class="p">()</span></pre></div>
</div>
<p>It has always been SQLAlchemy&#8217;s behavior such that if we access a scalar
or many-to-one attribute that was never set, it is returned as <code class="docutils literal"><span class="pre">None</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">obj</span><span class="o">.</span><span class="n">someattr</span>
<span class="go">None</span></pre></div>
</div>
<p>This value of <code class="docutils literal"><span class="pre">None</span></code> is in fact now part of the state of <code class="docutils literal"><span class="pre">obj</span></code>, and is
not unlike as though we had set the attribute explicitly, e.g.
<code class="docutils literal"><span class="pre">obj.someattr</span> <span class="pre">=</span> <span class="pre">None</span></code>.  However, the &#8220;set on get&#8221; here would behave
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">inspect</span><span class="p">(</span><span class="n">obj</span><span class="p">)</span><span class="o">.</span><span class="n">attrs</span><span class="o">.</span><span class="n">someattr</span><span class="o">.</span><span class="n">history</span>
<span class="go">History(added=(), unchanged=[None], deleted=())   # 0.9 and below</span></pre></div>
</div>
<p>That is, it&#8217;s as though the attribute were always <code class="docutils literal"><span class="pre">None</span></code> and were
never changed.  This is explicitly different from if we had set the
attribute first instead:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">obj</span> <span class="o">=</span> <span class="n">Foo</span><span class="p">()</span>
...
where we do in fact want to positively have <code class="docutils literal"><span class="pre">None</span></code> set.  Also, allowing
...
value <code class="xref py py-data docutils literal"><span class="pre">orm.attributes.NEVER_SET</span></code>, which is a value that may be sent
to an attribute listener now.   This symbol may also be received when
calling on mapper utility functions such as <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper.primary_key_from_instance" title="sqlalchemy.orm.mapper.Mapper.primary_key_from_instance"><code class="xref py py-meth docutils literal"><span class="pre">Mapper.primary_key_from_instance()</span></code></a>;
if the primary key attributes have no setting at all, whereas the value
would be <code class="docutils literal"><span class="pre">None</span></code> before, it will now be the <code class="xref py py-data docutils literal"><span class="pre">orm.attributes.NEVER_SET</span></code>
...
<p>As a side effect of <a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/3060">#3060</a>, setting a relationship-bound attribute to <code class="docutils literal"><span class="pre">None</span></code>
is now a tracked history event which refers to the intention of persisting
<code class="docutils literal"><span class="pre">None</span></code> to that attribute.   As it has always been the case that setting a
...
the value we assign is a reference to an <code class="docutils literal"><span class="pre">A</span></code> object or is <code class="docutils literal"><span class="pre">None</span></code>.
In 0.9, the behavior is inconsistent and
only takes effect if a value is assigned; the None is not considered:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">a1</span> <span class="o">=</span> <span class="n">A</span><span class="p">(</span><span class="nb">id</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>
...
<p>The behavior of <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.expunge" title="sqlalchemy.orm.session.Session.expunge"><code class="xref py py-meth docutils literal"><span class="pre">Session.expunge()</span></code></a> had a bug that caused an
inconsistency in behavior regarding deleted objects.  The
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.object_session" title="sqlalchemy.orm.session.object_session"><code class="xref py py-func docutils literal"><span class="pre">object_session()</span></code></a> function as well as the <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.state.InstanceState.session" title="sqlalchemy.orm.state.InstanceState.session"><code class="xref py py-attr docutils literal"><span class="pre">InstanceState.session</span></code></a>
attribute would still report object as belonging to the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a>
subsequent to the expunge:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">u1</span> <span class="o">=</span> <span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">first</span><span class="p">()</span>
...
<p>Note that it is normal for <code class="docutils literal"><span class="pre">u1</span> <span class="pre">not</span> <span class="pre">in</span> <span class="pre">sess</span></code> to be True while
<code class="docutils literal"><span class="pre">inspect(u1).session</span></code> still refers to the session, while the transaction
is ongoing subsequent to the delete operation and <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.expunge" title="sqlalchemy.orm.session.Session.expunge"><code class="xref py py-meth docutils literal"><span class="pre">Session.expunge()</span></code></a>
...
that rely on <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.expunge" title="sqlalchemy.orm.session.Session.expunge"><code class="xref py py-meth docutils literal"><span class="pre">Session.expunge()</span></code></a> such as <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.make_transient" title="sqlalchemy.orm.session.make_transient"><code class="xref py py-func docutils literal"><span class="pre">make_transient()</span></code></a>.</p>
...
<p>In order to make the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.yield_per" title="sqlalchemy.orm.query.Query.yield_per"><code class="xref py py-meth docutils literal"><span class="pre">Query.yield_per()</span></code></a> method easier to use,
...
When this error is raised, the <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.lazyload" title="sqlalchemy.orm.lazyload"><code class="xref py py-func docutils literal"><span class="pre">lazyload()</span></code></a> option can be sent with
an asterisk:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">q</span> <span class="o">=</span> <span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Object</span><span class="p">)</span><span class="o">.</span><span class="n">options</span><span class="p">(</span><span class="n">lazyload</span><span class="p">(</span><span class="s1">&#39;*&#39;</span><span class="p">))</span><span class="o">.</span><span class="n">yield_per</span><span class="p">(</span><span class="mi">100</span><span class="p">)</span></pre></div>
</div>
<p>or use <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.enable_eagerloads" title="sqlalchemy.orm.query.Query.enable_eagerloads"><code class="xref py py-meth docutils literal"><span class="pre">Query.enable_eagerloads()</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">q</span> <span class="o">=</span> <span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Object</span><span class="p">)</span><span class="o">.</span><span class="n">enable_eagerloads</span><span class="p">(</span><span class="kc">False</span><span class="p">)</span><span class="o">.</span><span class="n">yield_per</span><span class="p">(</span><span class="mi">100</span><span class="p">)</span></pre></div>
</div>
<p>The <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.lazyload" title="sqlalchemy.orm.lazyload"><code class="xref py py-func docutils literal"><span class="pre">lazyload()</span></code></a> option has the advantage that additional many-to-one
joined loader options can still be used:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">q</span> <span class="o">=</span> <span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Object</span><span class="p">)</span><span class="o">.</span><span class="n">options</span><span class="p">(</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">String</span><span class="p">,</span> <span class="n">ForeignKey</span>
...
<p>A query that joins to <code class="docutils literal"><span class="pre">A.bs</span></code> twice:</p>
...
<p>Will render:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span>
...
<p>The query deduplicates the redundant <code class="docutils literal"><span class="pre">A.bs</span></code> because it is attempting
to support a case like the following:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">A</span><span class="p">)</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">A</span><span class="o">.</span><span class="n">bs</span><span class="p">)</span><span class="o">.</span>\
...
<p>That is, the <code class="docutils literal"><span class="pre">A.bs</span></code> is part of a &#8220;path&#8221;.  As part of <a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/3367">#3367</a>,
arriving at the same endpoint twice without it being part of a
larger path will now emit a warning:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SAWarning</span><span class="p">:</span> <span class="n">Pathed</span> <span class="n">join</span> <span class="n">target</span> <span class="n">A</span><span class="o">.</span><span class="n">bs</span> <span class="n">has</span> <span class="n">already</span> <span class="n">been</span> <span class="n">joined</span> <span class="n">to</span><span class="p">;</span> <span class="n">skipping</span></pre></div>
</div>
<p>The bigger change involves when joining to an entity without using a
relationship-bound path.  If we join to <code class="docutils literal"><span class="pre">B</span></code> twice:</p>
...
the identical SQL:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="n">a</span><span class="o">.</span><span class="n">type</span> <span class="n">AS</span> <span class="n">a_type</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">asub2_alias</span> <span class="o">=</span> <span class="n">aliased</span><span class="p">(</span><span class="n">ASub2</span><span class="p">)</span>
...
<a class="reference internal" href="../orm/loading_columns.html#sqlalchemy.orm.undefer" title="sqlalchemy.orm.undefer"><code class="xref py py-func docutils literal"><span class="pre">undefer()</span></code></a> or similar option should now be used, in order
...
0.5, have been removed:   <code class="docutils literal"><span class="pre">translate_row</span></code>, <code class="docutils literal"><span class="pre">populate_instance</span></code>,
<code class="docutils literal"><span class="pre">append_result</span></code>, <code class="docutils literal"><span class="pre">create_instance</span></code>.  The use cases for these hooks
...
<p>The new <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Bundle" title="sqlalchemy.orm.query.Bundle"><code class="xref py py-class docutils literal"><span class="pre">Bundle</span></code></a> object of 0.9 has a small change in API,
when the <code class="docutils literal"><span class="pre">create_row_processor()</span></code> method is overridden on a custom class.
...
<p>The unused <code class="docutils literal"><span class="pre">result</span></code> member is now removed:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.orm</span> <span class="k">import</span> <span class="n">Bundle</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/loading_columns.html#bundles"><span class="std std-ref">Column Bundles</span></a></p>
</div>
</div>
...
<p>The behavior of <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.joinedload.params.innerjoin" title="sqlalchemy.orm.joinedload"><code class="xref py py-paramref docutils literal"><span class="pre">joinedload.innerjoin</span></code></a> as well as
...
outer join when an outer join is present, use <code class="docutils literal"><span class="pre">innerjoin=&quot;unnested&quot;</span></code>.</p>
...
<code class="docutils literal"><span class="pre">innerjoin=&quot;nested&quot;</span></code> is that an inner join eager load chained to an outer
join eager load will use a right-nested join.  <code class="docutils literal"><span class="pre">&quot;nested&quot;</span></code> is now implied
when using <code class="docutils literal"><span class="pre">innerjoin=True</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">options</span><span class="p">(</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">FROM</span> <span class="n">users</span> <span class="n">LEFT</span> <span class="n">OUTER</span> <span class="n">JOIN</span> <span class="p">(</span><span class="n">orders</span> <span class="n">JOIN</span> <span class="n">items</span> <span class="n">ON</span> <span class="o">&lt;</span><span class="n">onclause</span><span class="o">&gt;</span><span class="p">)</span> <span class="n">ON</span> <span class="o">&lt;</span><span class="n">onclause</span><span class="o">&gt;</span></pre></div>
</div>
<p>That is, using a right-nested join for the INNER join so that the full
result of <code class="docutils literal"><span class="pre">users</span></code> can be returned.   The use of an INNER join is more efficient
than using an OUTER join, and allows the <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.joinedload.params.innerjoin" title="sqlalchemy.orm.joinedload"><code class="xref py py-paramref docutils literal"><span class="pre">joinedload.innerjoin</span></code></a>
optimization parameter to take effect in all cases.</p>
<p>To get the older behavior, use <code class="docutils literal"><span class="pre">innerjoin=&quot;unnested&quot;</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">options</span><span class="p">(</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">FROM</span> <span class="n">users</span> <span class="n">LEFT</span> <span class="n">OUTER</span> <span class="n">JOIN</span> <span class="n">orders</span> <span class="n">ON</span> <span class="o">&lt;</span><span class="n">onclause</span><span class="o">&gt;</span> <span class="n">LEFT</span> <span class="n">OUTER</span> <span class="n">JOIN</span> <span class="n">items</span> <span class="n">ON</span> <span class="o">&lt;</span><span class="n">onclause</span><span class="o">&gt;</span></pre></div>
</div>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="migration_09.html#feature-2976"><span class="std std-ref">Right-nested inner joins available in joined eager loads</span></a> - description of the feature as introduced in 0.9.4.</p>
</div>
...
<p>SQLAlchemy considers the relationship <code class="docutils literal"><span class="pre">A.b</span></code> to be a &#8220;one to many,
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">anon_1</span><span class="o">.</span><span class="n">a_id</span> <span class="n">AS</span> <span class="n">anon_1_a_id</span><span class="p">,</span> <span class="n">b_1</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">b_1_id</span><span class="p">,</span> <span class="n">b_1</span><span class="o">.</span><span class="n">a_id</span> <span class="n">AS</span> <span class="n">b_1_a_id</span>
...
that at most only one row is shared in the case of <code class="docutils literal"><span class="pre">uselist=False</span></code>
(in the same way as a many-to-one), the &#8220;subquery&#8221; used with LIMIT +
joined eager loading is now dropped in this case:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="n">b_1</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">b_1_id</span><span class="p">,</span> <span class="n">b_1</span><span class="o">.</span><span class="n">a_id</span> <span class="n">AS</span> <span class="n">b_1_a_id</span>
...
<code class="docutils literal"><span class="pre">uselist=False</span></code>, so the results in that error situation should not change.</p>
...
June 9, 2015) when the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal"><span class="pre">Query.update()</span></code></a> or <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.delete" title="sqlalchemy.orm.query.Query.delete"><code class="xref py py-meth docutils literal"><span class="pre">Query.delete()</span></code></a> methods
are invoked against a query which has also called upon <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.join" title="sqlalchemy.orm.query.Query.join"><code class="xref py py-meth docutils literal"><span class="pre">Query.join()</span></code></a>,
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.outerjoin" title="sqlalchemy.orm.query.Query.outerjoin"><code class="xref py py-meth docutils literal"><span class="pre">Query.outerjoin()</span></code></a>,
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.select_from" title="sqlalchemy.orm.query.Query.select_from"><code class="xref py py-meth docutils literal"><span class="pre">Query.select_from()</span></code></a> or <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.from_self" title="sqlalchemy.orm.query.Query.from_self"><code class="xref py py-meth docutils literal"><span class="pre">Query.from_self()</span></code></a>.  These are unsupported
...
<h3>query.update() with <code class="docutils literal"><span class="pre">synchronize_session='evaluate'</span></code> raises on multi-table update<a class="headerlink" href="#query-update-with-synchronize-session-evaluate-raises-on-multi-table-update" title="Permalink to this headline">¶</a></h3>
<p>The &#8220;evaluator&#8221; for <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal"><span class="pre">Query.update()</span></code></a> won&#8217;t work with multi-table
updates, and needs to be set to <code class="docutils literal"><span class="pre">synchronize_session=False</span></code> or
<code class="docutils literal"><span class="pre">synchronize_session='fetch'</span></code> when multiple tables are present.
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Widget</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
...
<p>Using <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.from_self" title="sqlalchemy.orm.query.Query.from_self"><code class="xref py py-meth docutils literal"><span class="pre">Query.from_self()</span></code></a> or <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.count" title="sqlalchemy.orm.query.Query.count"><code class="xref py py-meth docutils literal"><span class="pre">Query.count()</span></code></a> against a subclass
would produce a subquery, but then add the &#8220;WHERE&#8221; criteria for subtypes
to the outside:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">FooWidget</span><span class="p">)</span><span class="o">.</span><span class="n">from_self</span><span class="p">()</span><span class="o">.</span><span class="n">all</span><span class="p">()</span></pre></div>
</div>
<p>rendering:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>SELECT
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">FooWidget</span><span class="o">.</span><span class="n">id</span><span class="p">)</span><span class="o">.</span><span class="n">count</span><span class="p">()</span></pre></div>
</div>
<p>Renders:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>SELECT count(*) AS count_1
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Related</span><span class="p">)</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">FooWidget</span><span class="p">,</span> <span class="n">Related</span><span class="o">.</span><span class="n">widget</span><span class="p">)</span><span class="o">.</span><span class="n">all</span><span class="p">()</span></pre></div>
</div>
<p>SQL output:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">related</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">related_id</span>
...
<p>Above, because we joined to a subclass <code class="docutils literal"><span class="pre">FooWidget</span></code>, <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.join" title="sqlalchemy.orm.query.Query.join"><code class="xref py py-meth docutils literal"><span class="pre">Query.join()</span></code></a>
knew to add the <code class="docutils literal"><span class="pre">AND</span> <span class="pre">widget.type</span> <span class="pre">IN</span> <span class="pre">('foo')</span></code> criteria to the ON clause.</p>
<p>The change here is that the <code class="docutils literal"><span class="pre">AND</span> <span class="pre">widget.type</span> <span class="pre">IN()</span></code> criteria is now appended
to <em>any</em> ON clause, not just those generated from a relationship,
including one that is explicitly stated:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># ON clause will now render as</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#bug-3233"><span class="std std-ref">Changes and fixes in handling of duplicate join targets</span></a></p>
</div>
...
full SQL string to <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection.execute" title="sqlalchemy.engine.Connection.execute"><code class="xref py py-meth docutils literal"><span class="pre">Connection.execute()</span></code></a>, but that you can send strings
with SQL expressions into many functions, such as <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.where" title="sqlalchemy.sql.expression.Select.where"><code class="xref py py-meth docutils literal"><span class="pre">Select.where()</span></code></a>,
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.filter" title="sqlalchemy.orm.query.Query.filter"><code class="xref py py-meth docutils literal"><span class="pre">Query.filter()</span></code></a>, and <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.order_by" title="sqlalchemy.sql.expression.Select.order_by"><code class="xref py py-meth docutils literal"><span class="pre">Select.order_by()</span></code></a>.</p>
<p>Note that by &#8220;SQL expressions&#8221; we mean a <strong>full fragment of a SQL string</strong>,
such as:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># the argument sent to where() is a full SQL expression</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># This is a normal Core expression with a string argument -</span>
...
using a <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.select" title="sqlalchemy.sql.expression.select"><code class="xref py py-func docutils literal"><span class="pre">select()</span></code></a> construct where virtually all components of it
...
like <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.filter" title="sqlalchemy.orm.query.Query.filter"><code class="xref py py-meth docutils literal"><span class="pre">Query.filter()</span></code></a>.</p>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="s2">&quot;a&quot;</span><span class="p">,</span> <span class="s2">&quot;b&quot;</span><span class="p">])</span><span class="o">.</span><span class="n">where</span><span class="p">(</span><span class="s2">&quot;a = b&quot;</span><span class="p">)</span><span class="o">.</span><span class="n">select_from</span><span class="p">(</span><span class="s2">&quot;sometable&quot;</span><span class="p">)</span></pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SAWarning</span><span class="p">:</span> <span class="n">Textual</span> <span class="n">column</span> <span class="n">expression</span> <span class="s1">&#39;a&#39;</span> <span class="n">should</span> <span class="n">be</span> <span class="n">explicitly</span> <span class="n">declared</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">select</span><span class="p">,</span> <span class="n">text</span>
...
about the text if we use <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.column" title="sqlalchemy.sql.expression.column"><code class="xref py py-func docutils literal"><span class="pre">column()</span></code></a> and <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.table" title="sqlalchemy.sql.expression.table"><code class="xref py py-func docutils literal"><span class="pre">table()</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">select</span><span class="p">,</span> <span class="n">text</span><span class="p">,</span> <span class="n">column</span><span class="p">,</span> <span class="n">table</span>
...
<p>Where note also that <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.table" title="sqlalchemy.sql.expression.table"><code class="xref py py-func docutils literal"><span class="pre">table()</span></code></a> and <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.column" title="sqlalchemy.sql.expression.column"><code class="xref py py-func docutils literal"><span class="pre">column()</span></code></a> can now
be imported from &#8220;sqlalchemy&#8221; without the &#8220;sql&#8221; part.</p>
<p>The behavior here applies to <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.select" title="sqlalchemy.sql.expression.select"><code class="xref py py-func docutils literal"><span class="pre">select()</span></code></a> as well as to key methods
on <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a>, including <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.filter" title="sqlalchemy.orm.query.Query.filter"><code class="xref py py-meth docutils literal"><span class="pre">Query.filter()</span></code></a>,
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.from_statement" title="sqlalchemy.orm.query.Query.from_statement"><code class="xref py py-meth docutils literal"><span class="pre">Query.from_statement()</span></code></a> and <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.having" title="sqlalchemy.orm.query.Query.having"><code class="xref py py-meth docutils literal"><span class="pre">Query.having()</span></code></a>.</p>
...
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.select" title="sqlalchemy.sql.expression.select"><code class="xref py py-func docutils literal"><span class="pre">select()</span></code></a> or <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> that refers to some column name or named
...
the <code class="docutils literal"><span class="pre">&quot;name&quot;</span></code> expression has been resolved to <code class="docutils literal"><span class="pre">users.name</span></code>!):</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">users</span><span class="o">.</span><span class="n">name</span><span class="p">,</span> <span class="n">count</span><span class="p">(</span><span class="n">users</span><span class="o">.</span><span class="n">id</span><span class="p">)</span> <span class="n">AS</span> <span class="n">id_count</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SAWarning</span><span class="p">:</span> <span class="n">Can</span><span class="s1">&#39;t resolve label reference &#39;</span><span class="n">some_label</span><span class="s1">&#39;; converting to</span>
...
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal"><span class="pre">text()</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="n">users</span><span class="p">])</span><span class="o">.</span><span class="n">order_by</span><span class="p">(</span><span class="n">text</span><span class="p">(</span><span class="s2">&quot;some special expression&quot;</span><span class="p">))</span></pre></div>
</div>
...
a <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal"><span class="pre">text()</span></code></a> construct, or a column, table, etc., and if we use it as a
...
be qualified with <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal"><span class="pre">text()</span></code></a> or similar.</p>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/2992">#2992</a></p>
</div>
</div>
<div class="section" id="python-side-defaults-invoked-for-each-row-invidually-when-using-a-multivalued-insert">
<span id="bug-3288"></span><h3>Python-side defaults invoked for each row invidually when using a multivalued insert<a class="headerlink" href="#python-side-defaults-invoked-for-each-row-invidually-when-using-a-multivalued-insert" title="Permalink to this headline">¶</a></h3>
<p>Support for Python-side column defaults when using the multi-valued
version of <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert.values" title="sqlalchemy.sql.expression.Insert.values"><code class="xref py py-meth docutils literal"><span class="pre">Insert.values()</span></code></a> were essentially not implemented, and
...
<p>The above example will invoke <code class="docutils literal"><span class="pre">next(counter)</span></code> for each row individually
as would be expected:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>INSERT INTO my_table (id, data) VALUES (?, ?), (?, ?), (?, ?)
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">Incorrect</span> <span class="n">number</span> <span class="n">of</span> <span class="n">bindings</span> <span class="n">supplied</span><span class="o">.</span> <span class="n">The</span> <span class="n">current</span> <span class="n">statement</span> <span class="n">uses</span> <span class="mi">6</span><span class="p">,</span>
...
<span class="p">[</span><span class="n">SQL</span><span class="p">:</span> <span class="s1">u&#39;INSERT INTO my_table (id, data) VALUES (?, ?), (?, ?), (?, ?)&#39;</span><span class="p">]</span>
...
relied on this):</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">INSERT</span> <span class="n">INTO</span> <span class="n">my_table</span> <span class="p">(</span><span class="nb">id</span><span class="p">,</span> <span class="n">data</span><span class="p">)</span> <span class="n">VALUES</span> <span class="p">(:</span><span class="nb">id</span><span class="p">,</span> <span class="p">:</span><span class="n">data_0</span><span class="p">),</span> <span class="p">(:</span><span class="nb">id</span><span class="p">,</span> <span class="p">:</span><span class="n">data_1</span><span class="p">),</span> <span class="p">(:</span><span class="nb">id</span><span class="p">,</span> <span class="p">:</span><span class="n">data_2</span><span class="p">)</span>
<span class="p">{</span><span class="s1">u&#39;data_2&#39;</span><span class="p">:</span> <span class="s1">&#39;d3&#39;</span><span class="p">,</span> <span class="s1">u&#39;data_1&#39;</span><span class="p">:</span> <span class="s1">&#39;d2&#39;</span><span class="p">,</span> <span class="s1">u&#39;data_0&#39;</span><span class="p">:</span> <span class="s1">&#39;d1&#39;</span><span class="p">,</span> <span class="s1">&#39;id&#39;</span><span class="p">:</span> <span class="mi">1</span><span class="p">}</span></pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">t</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    <span class="s1">&#39;my_table&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;id&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">),</span>
...
<span class="p">{</span><span class="s1">u&#39;data_1&#39;</span><span class="p">:</span> <span class="s1">&#39;d2&#39;</span><span class="p">,</span> <span class="s1">u&#39;data_0&#39;</span><span class="p">:</span> <span class="s1">&#39;d1&#39;</span><span class="p">}</span></pre></div>
</div>
...
with <code class="docutils literal"><span class="pre">collections.deque()</span></code>, which does not allow any additions or
removals during iteration, and instead raises <code class="docutils literal"><span class="pre">RuntimeError</span></code>.</p>
...
<span id="change-3169"></span><h3>The INSERT...FROM SELECT construct now implies <code class="docutils literal"><span class="pre">inline=True</span></code><a class="headerlink" href="#the-insert-from-select-construct-now-implies-inline-true" title="Permalink to this headline">¶</a></h3>
...
on <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.dml.insert" title="sqlalchemy.dialects.postgresql.dml.insert"><code class="xref py py-func docutils literal"><span class="pre">insert()</span></code></a>.  This helps to fix a bug where an
...
<span id="change-3027"></span><h3><code class="docutils literal"><span class="pre">autoload_with</span></code> now implies <code class="docutils literal"><span class="pre">autoload=True</span></code><a class="headerlink" href="#autoload-with-now-implies-autoload-true" title="Permalink to this headline">¶</a></h3>
<p>A <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> can be set up for reflection by passing
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.params.autoload_with" title="sqlalchemy.schema.Table"><code class="xref py py-paramref docutils literal"><span class="pre">Table.autoload_with</span></code></a> alone:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">my_table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;my_table&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span> <span class="n">autoload_with</span><span class="o">=</span><span class="n">some_engine</span><span class="p">)</span></pre></div>
</div>
...
case where a <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a> object was invalidated, and then tried
to reconnect and encountered an error; this has been resolved.</p>
<p>Additionally, the recently added <a class="reference internal" href="../core/events.html#sqlalchemy.events.ConnectionEvents.handle_error" title="sqlalchemy.events.ConnectionEvents.handle_error"><code class="xref py py-meth docutils literal"><span class="pre">ConnectionEvents.handle_error()</span></code></a>
event is now invoked for errors that occur upon initial connect, upon
reconnect, and when <a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine" title="sqlalchemy.create_engine"><code class="xref py py-func docutils literal"><span class="pre">create_engine()</span></code></a> is used given a custom connection
function via <a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine.params.creator" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal"><span class="pre">create_engine.creator</span></code></a>.</p>
<p>The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ExceptionContext" title="sqlalchemy.engine.ExceptionContext"><code class="xref py py-class docutils literal"><span class="pre">ExceptionContext</span></code></a> object has a new datamember
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ExceptionContext.engine" title="sqlalchemy.engine.ExceptionContext.engine"><code class="xref py py-attr docutils literal"><span class="pre">ExceptionContext.engine</span></code></a> that will always refer to the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal"><span class="pre">Engine</span></code></a>
in use, in those cases when the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a> object is not available
...
<p><code class="xref py py-attr docutils literal"><span class="pre">ForeignKeyConstraint.columns</span></code> was previously a plain list
containing either strings or <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> objects, depending on
how the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">ForeignKeyConstraint</span></code></a> was constructed and whether it was
associated with a table.  The collection is now a <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.ColumnCollection" title="sqlalchemy.sql.expression.ColumnCollection"><code class="xref py py-class docutils literal"><span class="pre">ColumnCollection</span></code></a>,
and is only initialized after the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">ForeignKeyConstraint</span></code></a> is
associated with a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a>.  A new accessor
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint.column_keys" title="sqlalchemy.schema.ForeignKeyConstraint.column_keys"><code class="xref py py-attr docutils literal"><span class="pre">ForeignKeyConstraint.column_keys</span></code></a>
...
<p>The sorting of tables resulting from the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData.sorted_tables" title="sqlalchemy.schema.MetaData.sorted_tables"><code class="xref py py-attr docutils literal"><span class="pre">MetaData.sorted_tables</span></code></a>
...
when emitting <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData.create_all" title="sqlalchemy.schema.MetaData.create_all"><code class="xref py py-meth docutils literal"><span class="pre">MetaData.create_all()</span></code></a> or <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData.drop_all" title="sqlalchemy.schema.MetaData.drop_all"><code class="xref py py-meth docutils literal"><span class="pre">MetaData.drop_all()</span></code></a>.</p>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">select</span><span class="p">([</span><span class="n">null</span><span class="p">(),</span> <span class="n">null</span><span class="p">()])</span></pre></div>
</div>
<p>rendering only <code class="docutils literal"><span class="pre">SELECT</span> <span class="pre">NULL</span> <span class="pre">AS</span> <span class="pre">anon_1</span></code>, because the two <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.null" title="sqlalchemy.sql.expression.null"><code class="xref py py-func docutils literal"><span class="pre">null()</span></code></a>
constructs would come out as the same  <code class="docutils literal"><span class="pre">NULL</span></code> object, and
...
<a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_temp_view_names" title="sqlalchemy.engine.reflection.Inspector.get_temp_view_names"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_temp_view_names()</span></code></a>.</p>
<p>Note that reflection of a specific named temporary table or temporary view,
either by <code class="docutils literal"><span class="pre">Table('name',</span> <span class="pre">autoload=True)</span></code> or via methods like
<a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_columns" title="sqlalchemy.engine.reflection.Inspector.get_columns"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_columns()</span></code></a> continues to function for most if not all
...
<p>The rules for PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ENUM" title="sqlalchemy.dialects.postgresql.ENUM"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ENUM</span></code></a> have been made more strict
with regards to creating and dropping of the TYPE.</p>
<p>An <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ENUM" title="sqlalchemy.dialects.postgresql.ENUM"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ENUM</span></code></a> that is created <strong>without</strong> being explicitly
associated with a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData" title="sqlalchemy.schema.MetaData"><code class="xref py py-class docutils literal"><span class="pre">MetaData</span></code></a> object will be created <em>and</em> dropped
corresponding to <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.create" title="sqlalchemy.schema.Table.create"><code class="xref py py-meth docutils literal"><span class="pre">Table.create()</span></code></a> and <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.drop" title="sqlalchemy.schema.Table.drop"><code class="xref py py-meth docutils literal"><span class="pre">Table.drop()</span></code></a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;sometable&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<p>An <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ENUM" title="sqlalchemy.dialects.postgresql.ENUM"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ENUM</span></code></a> that is created <strong>with</strong> being explicitly
associated with a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData" title="sqlalchemy.schema.MetaData"><code class="xref py py-class docutils literal"><span class="pre">MetaData</span></code></a> object will <em>not</em> be created <em>or</em> dropped
corresponding to <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.create" title="sqlalchemy.schema.Table.create"><code class="xref py py-meth docutils literal"><span class="pre">Table.create()</span></code></a> and <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.drop" title="sqlalchemy.schema.Table.drop"><code class="xref py py-meth docutils literal"><span class="pre">Table.drop()</span></code></a>, with
the exception of <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.create" title="sqlalchemy.schema.Table.create"><code class="xref py py-meth docutils literal"><span class="pre">Table.create()</span></code></a> called with the <code class="docutils literal"><span class="pre">checkfirst=True</span></code>
flag:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">my_enum</span> <span class="o">=</span> <span class="n">ENUM</span><span class="p">(</span><span class="s1">&#39;a&#39;</span><span class="p">,</span> <span class="s1">&#39;b&#39;</span><span class="p">,</span> <span class="s1">&#39;c&#39;</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="s1">&#39;myenum&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="o">=</span><span class="n">metadata</span><span class="p">)</span>
...
the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> construct.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/postgresql.html#postgresql-table-options"><span class="std std-ref">PostgreSQL Table Options</span></a></p>
</div>
...
<p>The <a class="reference internal" href="../core/inspection.html#sqlalchemy.inspection.inspect" title="sqlalchemy.inspection.inspect"><code class="xref py py-func docutils literal"><span class="pre">inspect()</span></code></a> method returns a <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.base.PGInspector" title="sqlalchemy.dialects.postgresql.base.PGInspector"><code class="xref py py-class docutils literal"><span class="pre">PGInspector</span></code></a> object in the
case of PostgreSQL, which includes a new <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.base.PGInspector.get_enums" title="sqlalchemy.dialects.postgresql.base.PGInspector.get_enums"><code class="xref py py-meth docutils literal"><span class="pre">PGInspector.get_enums()</span></code></a>
method that returns information on all available <code class="docutils literal"><span class="pre">ENUM</span></code> types:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">inspect</span><span class="p">,</span> <span class="n">create_engine</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.base.PGInspector.get_enums" title="sqlalchemy.dialects.postgresql.base.PGInspector.get_enums"><code class="xref py py-meth docutils literal"><span class="pre">PGInspector.get_enums()</span></code></a></p>
</div>
</div>
...
<ul class="simple">
<li>the <code class="xref py py-class docutils literal"><span class="pre">Table</span></code> construct with <code class="docutils literal"><span class="pre">autoload=True</span></code> will now match a name
that exists in the database as a materialized view or foreign table.</li>
<li><a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_view_names" title="sqlalchemy.engine.reflection.Inspector.get_view_names"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_view_names()</span></code></a> will return plain and materialized view
names.</li>
<li><a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_table_names" title="sqlalchemy.engine.reflection.Inspector.get_table_names"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_table_names()</span></code></a> does <strong>not</strong> change for PostgreSQL, it
continues to return only the names of plain tables.</li>
<li>A new method <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.base.PGInspector.get_foreign_table_names" title="sqlalchemy.dialects.postgresql.base.PGInspector.get_foreign_table_names"><code class="xref py py-meth docutils literal"><span class="pre">PGInspector.get_foreign_table_names()</span></code></a> is added which
will return the names of tables that are specifically marked as &#8220;foreign&#8221;
in the PostgreSQL schema tables.</li>
</ul>
<p>The change to reflection involves adding <code class="docutils literal"><span class="pre">'m'</span></code> and <code class="docutils literal"><span class="pre">'f'</span></code> to the list
of qualifiers we use when querying <code class="docutils literal"><span class="pre">pg_class.relkind</span></code>, but this change
...
<span id="change-3264"></span><h3>PostgreSQL <code class="docutils literal"><span class="pre">has_table()</span></code> now works for temporary tables<a class="headerlink" href="#postgresql-has-table-now-works-for-temporary-tables" title="Permalink to this headline">¶</a></h3>
...
<a class="reference internal" href="../core/functions.html#sqlalchemy.sql.functions.FunctionElement.filter" title="sqlalchemy.sql.functions.FunctionElement.filter"><code class="xref py py-meth docutils literal"><span class="pre">FunctionElement.filter()</span></code></a>:</p>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p><a class="reference internal" href="../core/functions.html#sqlalchemy.sql.functions.FunctionElement.filter" title="sqlalchemy.sql.functions.FunctionElement.filter"><code class="xref py py-meth docutils literal"><span class="pre">FunctionElement.filter()</span></code></a></p>
<p class="last"><a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.FunctionFilter" title="sqlalchemy.sql.expression.FunctionFilter"><code class="xref py py-class docutils literal"><span class="pre">FunctionFilter</span></code></a></p>
</div>
</div>
...
<p>The <a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine.params.encoding" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal"><span class="pre">create_engine.encoding</span></code></a> parameter is now honored
by the pg8000 dialect, using on connect handler which
emits <code class="docutils literal"><span class="pre">SET</span> <span class="pre">CLIENT_ENCODING</span></code> matching the selected encoding.</p>
</div>
...
such a type, if the column is set up with <code class="docutils literal"><span class="pre">nullable=True</span></code>.   However,
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/mysql.html#mysql-timestamp-null"><span class="std std-ref">TIMESTAMP Columns and NULL</span></a></p>
</div>
...
<p>The <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-class docutils literal"><span class="pre">mysql.SET</span></code></a> type historically not included a system of handling
...
empty set as <code class="docutils literal"><span class="pre">set([''])</span></code> as is still the current behavior for the
...
with no way to discern between <code class="docutils literal"><span class="pre">set([''])</span></code> and <code class="docutils literal"><span class="pre">set()</span></code>.  It was left
to the user to determine if <code class="docutils literal"><span class="pre">set([''])</span></code> actually meant &#8220;empty set&#8221; or not.</p>
...
case, and the default behavior of <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-class docutils literal"><span class="pre">mysql.SET</span></code></a> is now:</p>
<ul class="simple">
<li>to treat the empty string <code class="docutils literal"><span class="pre">''</span></code> as returned by MySQL-python into the empty
set <code class="docutils literal"><span class="pre">set()</span></code>;</li>
<li>to convert the single-blank value set <code class="docutils literal"><span class="pre">set([''])</span></code> returned by
MySQL-Connector-Python into the empty set <code class="docutils literal"><span class="pre">set()</span></code>;</li>
<li>To handle the case of a set type that actually wishes includes the blank
value <code class="docutils literal"><span class="pre">''</span></code> in its list of possible values,
...
flag <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET.params.retrieve_as_bitwise" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-paramref docutils literal"><span class="pre">mysql.SET.retrieve_as_bitwise</span></code></a> is added in order to
enable this.</li>
</ul>
<p>Using the <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET.params.retrieve_as_bitwise" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-paramref docutils literal"><span class="pre">mysql.SET.retrieve_as_bitwise</span></code></a> flag allows the set
...
<p>The default behavior of <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-class docutils literal"><span class="pre">mysql.SET</span></code></a> otherwise remains the same,
...
<p>The MySQL dialect will now disable <a class="reference internal" href="../core/events.html#sqlalchemy.events.ConnectionEvents.handle_error" title="sqlalchemy.events.ConnectionEvents.handle_error"><code class="xref py py-meth docutils literal"><span class="pre">ConnectionEvents.handle_error()</span></code></a>
...
<h3>Changed the default value of <code class="docutils literal"><span class="pre">raise_on_warnings</span></code> for MySQL-Connector<a class="headerlink" href="#changed-the-default-value-of-raise-on-warnings-for-mysql-connector" title="Permalink to this headline">¶</a></h3>
...
but the <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.true" title="sqlalchemy.sql.expression.true"><code class="xref py py-func docutils literal"><span class="pre">true()</span></code></a> and <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.false" title="sqlalchemy.sql.expression.false"><code class="xref py py-func docutils literal"><span class="pre">false()</span></code></a> symbols again produce the
keywords &#8220;true&#8221; and &#8220;false&#8221;, so that an expression like <code class="docutils literal"><span class="pre">column.is_(true())</span></code>
...
<p>The return type of a <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.operators.ColumnOperators.match" title="sqlalchemy.sql.operators.ColumnOperators.match"><code class="xref py py-meth docutils literal"><span class="pre">ColumnOperators.match()</span></code></a> expression is now a new type
called <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.MatchType" title="sqlalchemy.types.MatchType"><code class="xref py py-class docutils literal"><span class="pre">MatchType</span></code></a>.  This is a subclass of <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Boolean" title="sqlalchemy.types.Boolean"><code class="xref py py-class docutils literal"><span class="pre">Boolean</span></code></a>,
...
on MySQL:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">connection</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">engine</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;mssql+pyodbc://scott:tiger@myhost:port/databasename?driver=SQL+Server+Native+Client+10.0&quot;</span><span class="p">)</span></pre></div>
</div>
...
<p>The rendering of the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Text" title="sqlalchemy.types.Text"><code class="xref py py-class docutils literal"><span class="pre">Text</span></code></a>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.UnicodeText" title="sqlalchemy.types.UnicodeText"><code class="xref py py-class docutils literal"><span class="pre">UnicodeText</span></code></a>, and <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.LargeBinary" title="sqlalchemy.types.LargeBinary"><code class="xref py py-class docutils literal"><span class="pre">LargeBinary</span></code></a>
...
<code class="xref py py-meth docutils literal"><span class="pre">CTE.with_suffixes()</span></code> that can assist with Oracle&#8217;s special directives:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">included_parts</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span>
