...
<li><span class="link-container first"><a class="reference external" href="#new-init-scalar-event-intercepts-default-values-at-orm-level">New init_scalar() event intercepts default values at ORM level</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#new-indexable-orm-extension">New Indexable ORM extension</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#improved-session-state-when-a-savepoint-is-cancelled-by-the-database">Improved Session state when a SAVEPOINT is cancelled by the database</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#erroneous-new-instance-x-conflicts-with-persistent-instance-y-flush-errors-fixed">Erroneous &#8220;new instance X conflicts with persistent instance Y&#8221; flush errors fixed</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#passive-deletes-feature-for-joined-inheritance-mappings">passive_deletes feature for joined-inheritance mappings</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#same-named-backrefs-will-not-raise-an-error-when-applied-to-concrete-inheritance-subclasses">Same-named backrefs will not raise an error when applied to concrete inheritance subclasses</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#same-named-relationships-on-inheriting-mappers-no-longer-warn">Same-named relationships on inheriting mappers no longer warn</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#hybrid-properties-and-methods-now-propagate-the-docstring-as-well-as-info">Hybrid properties and methods now propagate the docstring as well as .info</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#fix-involving-many-to-one-object-moves-with-user-initiated-foreign-key-manipulations">Fix involving many-to-one object moves with user-initiated foreign key manipulations</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#improvements-to-the-query-correlate-method-with-polymorphic-entities">Improvements to the Query.correlate method with polymorphic entities</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#stringify-of-query-will-consult-the-session-for-the-correct-dialect">Stringify of Query will consult the Session for the correct dialect</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#joined-eager-loading-where-the-same-entity-is-present-multiple-times-in-one-row">Joined eager loading where the same entity is present multiple times in one row</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-mutablelist-and-mutableset-helpers-added-to-the-mutation-tracking-extension">New MutableList and MutableSet helpers added to the mutation tracking extension</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#new-raise-raise-on-sql-loader-strategies">New &#8220;raise&#8221; / &#8220;raise_on_sql&#8221; loader strategies</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#mapper-order-by-is-deprecated">Mapper.order_by is deprecated</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#engines-now-invalidate-connections-run-error-handlers-for-baseexception">Engines now invalidate connections, run error handlers for BaseException</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#cte-support-for-insert-update-delete">CTE Support for INSERT, UPDATE, DELETE</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-range-and-rows-specification-within-window-functions">Support for RANGE and ROWS specification within window functions</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-the-sql-lateral-keyword">Support for the SQL LATERAL keyword</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-tablesample">Support for TABLESAMPLE</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#support-for-is-distinct-from-and-is-not-distinct-from">Support for IS DISTINCT FROM and IS NOT DISTINCT FROM</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#core-and-orm-support-for-full-outer-join">Core and ORM support for FULL OUTER JOIN</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#resultset-column-matching-enhancements-positional-column-setup-for-textual-sql">ResultSet column matching enhancements; positional column setup for textual SQL</a></span><ul>
<li><span class="link-container first"><a class="reference external" href="#textasfrom-columns-now-works-positionally">TextAsFrom.columns() now works positionally</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#positional-matching-is-trusted-over-name-based-matching-for-core-orm-sql-constructs">Positional matching is trusted over name-based matching for Core/ORM SQL constructs</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#much-less-likely-to-get-an-ambiguous-column-error-message">Much less likely to get an &#8220;ambiguous column&#8221; error message</a></span></li>
</ul>
</li>
<li><span class="link-container first"><a class="reference external" href="#support-for-python-s-native-enum-type-and-compatible-forms">Support for Python&#8217;s native <code class="docutils literal"><span class="pre">enum</span></code> type and compatible forms</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#negative-integer-indexes-accommodated-by-core-result-rows">Negative integer indexes accommodated by Core result rows</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#the-enum-type-now-does-in-python-validation-of-values">The <code class="docutils literal"><span class="pre">Enum</span></code> type now does in-Python validation of values</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#non-native-boolean-integer-values-coerced-to-zero-one-none-in-all-cases">Non-native boolean integer values coerced to zero/one/None in all cases</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#large-parameter-and-row-values-are-now-truncated-in-logging-and-exception-displays">Large parameter and row values are now truncated in logging and exception displays</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#json-support-added-to-core">JSON support added to Core</a></span><ul>
<li><span class="link-container first"><a class="reference external" href="#json-null-is-inserted-as-expected-with-orm-operations-regardless-of-column-default-present">JSON &#8220;null&#8221; is inserted as expected with ORM operations, regardless of column default present</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#multi-tenancy-schema-translation-for-table-objects">Multi-Tenancy Schema Translation for Table objects</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#friendly-stringification-of-core-sql-constructs-without-a-dialect">&#8220;Friendly&#8221; stringification of Core SQL constructs without a dialect</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#columns-no-longer-added-redundantly-with-distinct-order-by">Columns no longer added redundantly with DISTINCT + ORDER BY</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#same-named-validates-decorators-will-now-raise-an-exception">Same-named &#64;validates decorators will now raise an exception</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#textclause-columns-will-match-columns-positionally-not-by-name-when-passed-positionally">TextClause.columns() will match columns positionally, not by name, when passed positionally</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#string-server-default-now-literal-quoted">String server_default now literal quoted</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#support-for-insert-on-conflict-do-update-do-nothing">Support for INSERT..ON CONFLICT (DO UPDATE | DO NOTHING)</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#check-constraints-now-reflect">Check constraints now reflect</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#plain-and-materialized-views-can-be-inspected-separately">&#8220;Plain&#8221; and &#8220;Materialized&#8221; views can be inspected separately</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#added-tablespace-option-to-index">Added tablespace option to Index</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-pygresql">Support for PyGreSQL</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#the-postgres-module-is-removed">The &#8220;postgres&#8221; module is removed</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#support-for-for-update-skip-locked-for-no-key-update-for-key-share">Support for FOR UPDATE SKIP LOCKED  / FOR NO KEY UPDATE / FOR KEY SHARE</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#mysql-json-support">MySQL JSON Support</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#added-support-for-autocommit-isolation-level">Added support for AUTOCOMMIT &#8220;isolation level&#8221;</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#right-nested-join-workaround-lifted-for-sqlite-version-3-7-16">Right-nested join workaround lifted for SQLite version 3.7.16</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#dotted-column-names-workaround-lifted-for-sqlite-version-3-10-0">Dotted column names workaround lifted for SQLite version 3.10.0</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#reflection-of-the-name-of-primary-key-constraints">Reflection of the name of PRIMARY KEY constraints</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#id1">Check constraints now reflect</a></span></li>
<li><span class="link-container first"><a class="reference external" href="#on-delete-and-on-update-foreign-key-phrases-now-reflect">ON DELETE and ON UPDATE foreign key phrases now reflect</a></span></li>
</ul>
</li>
...
<li><span class="link-container first"><a class="reference external" href="#added-transaction-isolation-level-support-for-sql-server">Added transaction isolation level support for SQL Server</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#support-for-non-clustered-on-primary-key-to-allow-clustered-elsewhere">Support for &#8220;non clustered&#8221; on primary key to allow clustered elsewhere</a></span></li>
...
<li><span class="link-container first"><a class="reference external" href="#support-for-skip-locked">Support for SKIP LOCKED</a></span></li>
</ul>
</li>
</ul>
</li>
...
<p class="last">This document describes changes between SQLAlchemy version 1.0
...
as things like &#8220;extras&#8221;, <code class="docutils literal"><span class="pre">setup.py</span></code> now depends on Setuptools fully.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../intro.html#installation"><span class="std std-ref">Installation Guide</span></a></p>
</div>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../intro.html#c-extensions"><span class="std std-ref">Installing the C Extensions</span></a></p>
</div>
...
<p>The ORM produces a value of <code class="docutils literal"><span class="pre">None</span></code> when an attribute that has not been
set is first accessed, for a non-persistent object:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">obj</span> <span class="o">=</span> <span class="n">MyObj</span><span class="p">()</span>
...
To suit this use case a new event <a class="reference internal" href="../orm/events.html#sqlalchemy.orm.events.AttributeEvents.init_scalar" title="sqlalchemy.orm.events.AttributeEvents.init_scalar"><code class="xref py py-meth docutils literal"><span class="pre">AttributeEvents.init_scalar()</span></code></a>
is added.   The new example <code class="docutils literal"><span class="pre">active_column_defaults.py</span></code> at
...
SQL value (which is not already a <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.ClauseElement" title="sqlalchemy.sql.expression.ClauseElement"><code class="xref py py-class docutils literal"><span class="pre">ClauseElement</span></code></a> instance)
includes a method <code class="docutils literal"><span class="pre">__clause_element__()</span></code> which provides a
...
string value:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">some_user</span> <span class="o">=</span> <span class="n">User</span><span class="p">()</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="c1"># Address.user refers to the User mapper, so</span>
...
or JSON field:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Person</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
...
<p>Above, the <code class="docutils literal"><span class="pre">name</span></code> attribute will read/write the field <code class="docutils literal"><span class="pre">&quot;name&quot;</span></code>
from the JSON column <code class="docutils literal"><span class="pre">data</span></code>, after initializing it to an
empty dictionary:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">person</span> <span class="o">=</span> <span class="n">Person</span><span class="p">(</span><span class="n">name</span><span class="o">=</span><span class="s1">&#39;foobar&#39;</span><span class="p">)</span>
...
so that there&#8217;s no need to use <a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableDict" title="sqlalchemy.ext.mutable.MutableDict"><code class="xref py py-class docutils literal"><span class="pre">MutableDict</span></code></a> in order
to track this change.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/extensions/indexable.html"><span class="std std-ref">Indexable</span></a></p>
</div>
</div>
...
<a class="reference internal" href="#change-3514"><span class="std std-ref">JSON &#8220;null&#8221; is inserted as expected with ORM operations, regardless of column default present</span></a>, the base <a class="reference internal" href="../core/type_api.html#sqlalchemy.types.TypeEngine" title="sqlalchemy.types.TypeEngine"><code class="xref py py-class docutils literal"><span class="pre">TypeEngine</span></code></a> class now supports
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../orm/persistence_techniques.html#session-forcing-null"><span class="std std-ref">Forcing NULL on a column with a default</span></a></p>
</div>
...
<p>Continuing from 1.0&#8217;s <a class="reference internal" href="migration_10.html#migration-3177"><span class="std std-ref">Change to single-table-inheritance criteria when using from_self(), count()</span></a>, the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> should
...
<p>Produces:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">EXISTS</span> <span class="p">(</span><span class="n">SELECT</span> <span class="mi">1</span>
...
occurs within the transaction.  The <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a> has been modified
...
<p>The <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.rollback" title="sqlalchemy.orm.session.Session.rollback"><code class="xref py py-meth docutils literal"><span class="pre">Session.rollback()</span></code></a> method is responsible for removing objects
...
garbage collected from that collection, the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a> no longer worries
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Column</span><span class="p">,</span> <span class="n">create_engine</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span>FlushError: New instance &lt;User at 0x7f0287eca4d0&gt; with identity key
...
<div class="highlight-sql"><div class="highlight"><pre><span></span><span class="k">BEGIN</span> <span class="p">(</span><span class="k">implicit</span><span class="p">)</span>
...
as a result of <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.delete" title="sqlalchemy.orm.session.Session.delete"><code class="xref py py-meth docutils literal"><span class="pre">Session.delete()</span></code></a>, which only emits DELETE for the
...
the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.params.passive_deletes" title="sqlalchemy.orm.mapper"><code class="xref py py-paramref docutils literal"><span class="pre">orm.mapper.passive_deletes</span></code></a> option:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Column</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">String</span><span class="p">,</span> <span class="n">ForeignKey</span><span class="p">,</span> <span class="n">create_engine</span>
<span class="kn">from</span> <span class="nn">sqlalchemy.orm</span> <span class="k">import</span> <span class="n">Session</span>
<span class="kn">from</span> <span class="nn">sqlalchemy.ext.declarative</span> <span class="k">import</span> <span class="n">declarative_base</span>
...
<p>With the above mapping, the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.params.passive_deletes" title="sqlalchemy.orm.mapper"><code class="xref py py-paramref docutils literal"><span class="pre">orm.mapper.passive_deletes</span></code></a> option
...
an object of type <code class="docutils literal"><span class="pre">B</span></code> no longer needs to retrieve the primary key value
of <code class="docutils literal"><span class="pre">b_table_id</span></code> if unloaded, nor does it need to emit a DELETE statement
for the table itself:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">delete</span><span class="p">(</span><span class="n">some_b</span><span class="p">)</span>
<span class="n">session</span><span class="o">.</span><span class="n">commit</span><span class="p">()</span></pre></div>
</div>
<p>Will emit SQL as:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">DELETE</span> <span class="n">FROM</span> <span class="n">a</span> <span class="n">WHERE</span> <span class="n">a</span><span class="o">.</span><span class="n">id</span> <span class="o">=</span> <span class="o">%</span><span class="p">(</span><span class="nb">id</span><span class="p">)</span><span class="n">s</span>
...
<p>Above, even though class <code class="docutils literal"><span class="pre">A</span></code> and class <code class="docutils literal"><span class="pre">A1</span></code> have a relationship
named <code class="docutils literal"><span class="pre">b</span></code>, no conflict warning or error occurs because class <code class="docutils literal"><span class="pre">A1</span></code> is
...
<p><span class="versionmodified">New in version 1.1.0b3.</span></p>
</div>
...
<p>A hybrid method or property will now reflect the <code class="docutils literal"><span class="pre">__doc__</span></code> value
...
<p>The above value of <code class="docutils literal"><span class="pre">A.some_name.__doc__</span></code> is now honored:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">A</span><span class="o">.</span><span class="n">some_name</span><span class="o">.</span><span class="n">__doc__</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">assert</span> <span class="n">A</span><span class="o">.</span><span class="n">name</span> <span class="ow">is</span> <span class="n">A</span><span class="o">.</span><span class="n">some_name</span></pre></div>
</div>
<p>With the change, the expression returned by <code class="docutils literal"><span class="pre">A.some_name</span></code> is wrapped inside
of its own <code class="docutils literal"><span class="pre">QueryableAttribute</span></code> wrapper:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">A</span><span class="o">.</span><span class="n">some_name</span>
...
users.</p>
<p>As part of this change, the <code class="xref py py-attr docutils literal"><span class="pre">hybrid_property.info</span></code> collection is now
also propagated from the hybrid descriptor itself, rather than from the underlying
expression.  That is, accessing <code class="docutils literal"><span class="pre">A.some_name.info</span></code> now returns the same
dictionary that you&#8217;d get from <code class="docutils literal"><span class="pre">inspect(A).all_orm_descriptors['some_name'].info</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">A</span><span class="o">.</span><span class="n">some_name</span><span class="o">.</span><span class="n">info</span><span class="p">[</span><span class="s1">&#39;foo&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="s1">&#39;bar&#39;</span>
...
<p>Note that this <code class="docutils literal"><span class="pre">.info</span></code> dictionary is <strong>separate</strong> from that of a mapped attribute
...
of a mirrored attribute such as <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.attributes.QueryableAttribute.property" title="sqlalchemy.orm.attributes.QueryableAttribute.property"><code class="xref py py-attr docutils literal"><span class="pre">QueryableAttribute.property</span></code></a> and
<code class="xref py py-attr docutils literal"><span class="pre">QueryableAttribute.class_</span></code>.</p>
...
consistent.</p>
<p>Given:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">u1</span> <span class="o">=</span> <span class="n">User</span><span class="p">(</span><span class="nb">id</span><span class="o">=</span><span class="mi">7</span><span class="p">,</span> <span class="n">name</span><span class="o">=</span><span class="s1">&#39;x&#39;</span><span class="p">)</span>
...
mapping of the classes <code class="docutils literal"><span class="pre">Parent</span></code> and <code class="docutils literal"><span class="pre">SomeClass</span></code>, where <code class="docutils literal"><span class="pre">SomeClass.parent</span></code>
refers to <code class="docutils literal"><span class="pre">Parent</span></code> and <code class="docutils literal"><span class="pre">Parent.items</span></code> refers to the collection of
<code class="docutils literal"><span class="pre">SomeClass</span></code> objects:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">some_object</span> <span class="o">=</span> <span class="n">SomeClass</span><span class="p">()</span>
...
<p>Above, we&#8217;ve made a pending object <code class="docutils literal"><span class="pre">some_object</span></code>, manipulated its foreign key
towards <code class="docutils literal"><span class="pre">Parent</span></code> to refer to it, <em>then</em> we actually set up the relationship.
Before the bug fix, the backref would not have fired off:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># before the fix</span>
...
<code class="docutils literal"><span class="pre">some_object.parent</span></code>, we disregard the parent id that&#8217;s been manually set,
and we look for the database-committed value.  In this case, it&#8217;s None because
the object is pending, so the event system logs <code class="docutils literal"><span class="pre">some_object.parent</span></code>
as a net change:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># after the fix, backref fired off for some_object.parent = some_parent</span>
...
use of the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.enable_relationship_loading" title="sqlalchemy.orm.session.Session.enable_relationship_loading"><code class="xref py py-meth docutils literal"><span class="pre">Session.enable_relationship_loading()</span></code></a> and
<code class="xref py py-attr docutils literal"><span class="pre">RelationshipProperty.load_on_pending</span></code> features, which cause
...
To accommodate this, the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.correlate" title="sqlalchemy.orm.query.Query.correlate"><code class="xref py py-meth docutils literal"><span class="pre">Query.correlate()</span></code></a> method now extracts the
...
<code class="docutils literal"><span class="pre">Person/Manager/Engineer-&gt;Company</span></code> setup from the mapping documentation,
using with_polymorphic:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">sess</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Person</span><span class="o">.</span><span class="n">name</span><span class="p">)</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span>SELECT people.name AS people_name
FROM people
...
<p>Before the fix, the call to <code class="docutils literal"><span class="pre">correlate(Person)</span></code> would inadvertently
attempt to correlate to the join of <code class="docutils literal"><span class="pre">Person</span></code>, <code class="docutils literal"><span class="pre">Engineer</span></code> and <code class="docutils literal"><span class="pre">Manager</span></code>
as a single unit, so <code class="docutils literal"><span class="pre">Person</span></code> wouldn&#8217;t be correlated:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>-- old, incorrect query
...
unpolished edges.  If for example <code class="docutils literal"><span class="pre">Person</span></code> is polymorphically linked
...
to the &#8220;polymorphic&#8221; entity fully is to create an <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.aliased" title="sqlalchemy.orm.aliased"><code class="xref py py-func docutils literal"><span class="pre">aliased()</span></code></a> object
from it first:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># works with all SQLAlchemy versions and all types of polymorphic</span>
...
<p>The <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.aliased" title="sqlalchemy.orm.aliased"><code class="xref py py-func docutils literal"><span class="pre">aliased()</span></code></a> construct guarantees that the &#8220;polymorphic selectable&#8221;
...
<p>Calling <code class="docutils literal"><span class="pre">str()</span></code> on a <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object will consult the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a>
for the correct &#8220;bind&#8221; to use, in order to render the SQL that would be
passed to the database.  In particular this allows a <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> that
refers to dialect-specific SQL constructs to be renderable, assuming the
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> is associated with an appropriate <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a>.
Previously, this behavior would only take effect if the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData" title="sqlalchemy.schema.MetaData"><code class="xref py py-class docutils literal"><span class="pre">MetaData</span></code></a>
...
<p>If neither the underlying <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.MetaData" title="sqlalchemy.schema.MetaData"><code class="xref py py-class docutils literal"><span class="pre">MetaData</span></code></a> nor the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a> are
associated with any bound <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal"><span class="pre">Engine</span></code></a>, then the fallback to the
&#8220;default&#8221; dialect is used to generate the SQL string.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-3631"><span class="std std-ref">&#8220;Friendly&#8221; stringification of Core SQL constructs without a dialect</span></a></p>
</div>
...
<p>We can see that the <code class="docutils literal"><span class="pre">c</span></code> table is selected from twice; once in the context
of <code class="docutils literal"><span class="pre">A.b.c</span> <span class="pre">-&gt;</span> <span class="pre">c_alias_1</span></code> and another in the context of <code class="docutils literal"><span class="pre">A.c</span> <span class="pre">-&gt;</span> <span class="pre">c_alias_2</span></code>.
Also, we can see that it is quite possible that the <code class="docutils literal"><span class="pre">C</span></code> identity for a
single row is the <strong>same</strong> for both <code class="docutils literal"><span class="pre">c_alias_1</span></code> and <code class="docutils literal"><span class="pre">c_alias_2</span></code>, meaning
two sets of columns in one row result in only one new object being added
to the identity map.</p>
<p>The query options above only call for the attribute <code class="docutils literal"><span class="pre">C.d</span></code> to be loaded
in the context of <code class="docutils literal"><span class="pre">c_alias_1</span></code>, and not <code class="docutils literal"><span class="pre">c_alias_2</span></code>.  So whether or not
the final <code class="docutils literal"><span class="pre">C</span></code> object we get in the identity map has the <code class="docutils literal"><span class="pre">C.d</span></code> attribute
...
loader for <code class="docutils literal"><span class="pre">c_alias_1</span></code> is processed after that of <code class="docutils literal"><span class="pre">c_alias_2</span></code> for a
single row where they both refer to the same identity, the <code class="docutils literal"><span class="pre">C.d</span></code>
...
<p>New helper classes <a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableList" title="sqlalchemy.ext.mutable.MutableList"><code class="xref py py-class docutils literal"><span class="pre">MutableList</span></code></a> and <a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableSet" title="sqlalchemy.ext.mutable.MutableSet"><code class="xref py py-class docutils literal"><span class="pre">MutableSet</span></code></a> have been
...
<a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableDict" title="sqlalchemy.ext.mutable.MutableDict"><code class="xref py py-class docutils literal"><span class="pre">MutableDict</span></code></a> helper.</p>
...
corresponding loader option <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.raiseload" title="sqlalchemy.orm.raiseload"><code class="xref py py-func docutils literal"><span class="pre">orm.raiseload()</span></code></a> may be applied to a
relationship attribute which will cause it to raise <code class="docutils literal"><span class="pre">InvalidRequestError</span></code>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy.orm</span> <span class="k">import</span> <span class="n">raiseload</span>
...
the original design of the ORM which featured the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal"><span class="pre">Mapper</span></code></a> object
as a public-facing query structure.   This role has long since been replaced
by the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object, where we use <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.order_by" title="sqlalchemy.orm.query.Query.order_by"><code class="xref py py-meth docutils literal"><span class="pre">Query.order_by()</span></code></a> to
...
many areas in which <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper.params.order_by" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-paramref docutils literal"><span class="pre">Mapper.order_by</span></code></a> doesn&#8217;t work as expected
...
<div class="versionadded">
<p><span class="versionmodified">New in version 1.1: </span>this change is a late add to the 1.1 series just
prior to 1.1 final, and is not present in the 1.1 beta releases.</p>
</div>
<p>The Python <code class="docutils literal"><span class="pre">BaseException</span></code> class is below that of <code class="docutils literal"><span class="pre">Exception</span></code> but is the
identifiable base for system-level exceptions such as <code class="docutils literal"><span class="pre">KeyboardInterrupt</span></code>,
<code class="docutils literal"><span class="pre">SystemExit</span></code>, and notably the <code class="docutils literal"><span class="pre">GreenletExit</span></code> exception that&#8217;s used by
eventlet and gevent. This exception class is now intercepted by the exception-
handling routines of <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a>, and includes handling by the
<a class="reference internal" href="../core/events.html#sqlalchemy.events.ConnectionEvents.handle_error" title="sqlalchemy.events.ConnectionEvents.handle_error"><code class="xref py py-meth docutils literal"><span class="pre">handle_error()</span></code></a> event.  The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a> is now
<strong>invalidated</strong> by default in the case of a system level exception that is not
a subclass of <code class="docutils literal"><span class="pre">Exception</span></code>, as it is assumed an operation was interrupted and
...
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a> is disposed, and the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal"><span class="pre">Connection</span></code></a>, if still
...
any transaction in progress is lost and the appropriate <code class="docutils literal"><span class="pre">.rollback()</span></code> method
...
failures in context managers that call <code class="docutils literal"><span class="pre">.rollback()</span></code> upon the exception
catch.   The behavior here is expected to reduce
the incidence of the MySQL error &#8220;commands out of sync&#8221;, as well as the
<code class="docutils literal"><span class="pre">ResourceClosedError</span></code> which can occur when the MySQL driver fails to
report <code class="docutils literal"><span class="pre">cursor.description</span></code> correctly, when running under greenlet
conditions where greenlets are killed, or where <code class="docutils literal"><span class="pre">KeyboardInterrupt</span></code> exceptions
...
impacted by <code class="docutils literal"><span class="pre">KeyboardInterrupt</span></code> such as psycopg2.  For these DBAPIs,
the following workaround will disable the connection from being recycled
for specific exceptions:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">engine</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;postgresql+psycopg2://&quot;</span><span class="p">)</span>
...
statement:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">table</span><span class="p">,</span> <span class="n">column</span><span class="p">,</span> <span class="n">select</span><span class="p">,</span> <span class="n">literal</span><span class="p">,</span> <span class="n">exists</span>
...
<p>New <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.range_" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal"><span class="pre">expression.over.range_</span></code></a> and <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.rows" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal"><span class="pre">expression.over.rows</span></code></a> parameters allow
RANGE and ROWS expressions for window functions:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">func</span>
...
<p><a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.range_" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal"><span class="pre">expression.over.range_</span></code></a> and <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.rows" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal"><span class="pre">expression.over.rows</span></code></a> are specified as
2-tuples and indicate negative and positive values for specific ranges,
0 for &#8220;CURRENT ROW&#8221;, and None for UNBOUNDED.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../core/tutorial.html#window-functions"><span class="std std-ref">Window Functions</span></a></p>
</div>
...
is added to Core.   The implementation of <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.lateral" title="sqlalchemy.sql.expression.Select.lateral"><code class="xref py py-meth docutils literal"><span class="pre">Select.lateral()</span></code></a> employs
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">table</span><span class="p">,</span> <span class="n">column</span><span class="p">,</span> <span class="n">select</span><span class="p">,</span> <span class="n">true</span>
...
<p><a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Lateral" title="sqlalchemy.sql.expression.Lateral"><code class="xref py py-class docutils literal"><span class="pre">Lateral</span></code></a></p>
<p class="last"><a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.lateral" title="sqlalchemy.sql.expression.Select.lateral"><code class="xref py py-meth docutils literal"><span class="pre">Select.lateral()</span></code></a></p>
</div>
...
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.FromClause.tablesample" title="sqlalchemy.sql.expression.FromClause.tablesample"><code class="xref py py-meth docutils literal"><span class="pre">FromClause.tablesample()</span></code></a> method, which returns a <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.TableSample" title="sqlalchemy.sql.expression.TableSample"><code class="xref py py-class docutils literal"><span class="pre">TableSample</span></code></a>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># old way</span>
...
semantics unless a column is marked explicitly with <code class="docutils literal"><span class="pre">autoincrement=True</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># column &#39;y&#39; will be SERIAL/AUTO_INCREMENT/ auto-generating</span>
<span class="n">Table</span><span class="p">(</span>
    <span class="s1">&#39;some_table&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;x&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">),</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SAWarning</span><span class="p">:</span> <span class="n">Column</span> <span class="s1">&#39;b.x&#39;</span> <span class="ow">is</span> <span class="n">marked</span> <span class="k">as</span> <span class="n">a</span> <span class="n">member</span> <span class="n">of</span> <span class="n">the</span> <span class="n">primary</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-mysql-3216"><span class="std std-ref">No more generation of an implicit KEY for composite primary key w/ AUTO_INCREMENT</span></a></p>
</div>
...
<p>New operators <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.operators.ColumnOperators.is_distinct_from" title="sqlalchemy.sql.operators.ColumnOperators.is_distinct_from"><code class="xref py py-meth docutils literal"><span class="pre">ColumnOperators.is_distinct_from()</span></code></a> and
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.operators.ColumnOperators.isnot_distinct_from" title="sqlalchemy.sql.operators.ColumnOperators.isnot_distinct_from"><code class="xref py py-meth docutils literal"><span class="pre">ColumnOperators.isnot_distinct_from()</span></code></a> allow the IS DISTINCT
FROM and IS NOT DISTINCT FROM sql operation:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span> <span class="n">column</span><span class="p">(</span><span class="s1">&#39;x&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">is_distinct_from</span><span class="p">(</span><span class="kc">None</span><span class="p">)</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy.dialects</span> <span class="k">import</span> <span class="n">sqlite</span>
...
and ORM level, instructs the compiler to render <code class="docutils literal"><span class="pre">FULL</span> <span class="pre">OUTER</span> <span class="pre">JOIN</span></code>
where it would normally render <code class="docutils literal"><span class="pre">LEFT</span> <span class="pre">OUTER</span> <span class="pre">JOIN</span></code>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="n">t1</span><span class="p">])</span><span class="o">.</span><span class="n">select_from</span><span class="p">(</span><span class="n">t1</span><span class="o">.</span><span class="n">outerjoin</span><span class="p">(</span><span class="n">t2</span><span class="p">,</span> <span class="n">full</span><span class="o">=</span><span class="kc">True</span><span class="p">))</span></pre></div>
</div>
<p>The flag also works at the ORM level:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">q</span> <span class="o">=</span> <span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">MyClass</span><span class="p">)</span><span class="o">.</span><span class="n">outerjoin</span><span class="p">(</span><span class="n">MyOtherClass</span><span class="p">,</span> <span class="n">full</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span></pre></div>
</div>
...
<p>A series of improvements were made to the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal"><span class="pre">ResultProxy</span></code></a> system
...
constructs via the use of the recently added <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.TextClause.columns" title="sqlalchemy.sql.expression.TextClause.columns"><code class="xref py py-meth docutils literal"><span class="pre">TextClause.columns()</span></code></a> method.</p>
...
<p>The <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.TextClause.columns" title="sqlalchemy.sql.expression.TextClause.columns"><code class="xref py py-meth docutils literal"><span class="pre">TextClause.columns()</span></code></a> method, added in 0.9, accepts column-based arguments
...
and the column arguments passed to <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.TextClause.columns" title="sqlalchemy.sql.expression.TextClause.columns"><code class="xref py py-meth docutils literal"><span class="pre">TextClause.columns()</span></code></a>:</p>
...
columns from the <code class="docutils literal"><span class="pre">User</span></code> and <code class="docutils literal"><span class="pre">Address</span></code> class directly, even linking
the <code class="docutils literal"><span class="pre">Address.user_id</span></code> column to the <code class="docutils literal"><span class="pre">users.id</span></code> column in textual SQL
for fun, and the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal"><span class="pre">Query</span></code></a> object will receive rows that are correctly
...
<p class="last"><a class="reference internal" href="#behavior-change-3501"><span class="std std-ref">TextClause.columns() will match columns positionally, not by name, when passed positionally</span></a> - backwards compatibility remarks</p>
</div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">ua</span> <span class="o">=</span> <span class="n">users</span><span class="o">.</span><span class="n">alias</span><span class="p">(</span><span class="s1">&#39;ua&#39;</span><span class="p">)</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">users</span><span class="o">.</span><span class="n">user_id</span><span class="p">,</span> <span class="n">ua</span><span class="o">.</span><span class="n">user_id</span> <span class="n">FROM</span> <span class="n">users</span><span class="p">,</span> <span class="n">users</span> <span class="n">AS</span> <span class="n">ua</span></pre></div>
</div>
...
contains the <code class="docutils literal"><span class="pre">'user_id'</span></code> label duplicated, the &#8220;ambiguous column&#8221; rule
...
fetch columns:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">result</span> <span class="o">=</span> <span class="n">conn</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">stmt</span><span class="p">)</span>
...
<p>As part of this change, the wording of the error message <code class="docutils literal"><span class="pre">Ambiguous</span> <span class="pre">column</span>
...
<code class="docutils literal"><span class="pre">Ambiguous</span> <span class="pre">column</span> <span class="pre">name</span> <span class="pre">'&lt;name&gt;'</span> <span class="pre">in</span> <span class="pre">result</span> <span class="pre">set</span> <span class="pre">column</span> <span class="pre">descriptions</span></code>, and
only when a result column is retrieved using the string name that is actually
ambiguous, e.g. <code class="docutils literal"><span class="pre">row['user_id']</span></code> in the above example.  It also now refers
...
<span id="change-3292"></span><h3>Support for Python&#8217;s native <code class="docutils literal"><span class="pre">enum</span></code> type and compatible forms<a class="headerlink" href="#support-for-python-s-native-enum-type-and-compatible-forms" title="Permalink to this headline">¶</a></h3>
<p>The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal"><span class="pre">Enum</span></code></a> type can now be constructed using any
...
string values:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">enum</span>
...
<p>The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal"><span class="pre">RowProxy</span></code></a> object now accommodates single negative integer indexes
...
<span id="change-3095"></span><h3>The <code class="docutils literal"><span class="pre">Enum</span></code> type now does in-Python validation of values<a class="headerlink" href="#the-enum-type-now-does-in-python-validation-of-values" title="Permalink to this headline">¶</a></h3>
...
and a CHECK constraint is infeasible, the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal"><span class="pre">Enum</span></code></a> datatype now adds
in-Python validation of input values when the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum.params.validate_strings" title="sqlalchemy.types.Enum"><code class="xref py py-paramref docutils literal"><span class="pre">Enum.validate_strings</span></code></a>
flag is used (1.1.0b2):</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">Enum</span><span class="p">,</span> <span class="n">create_engine</span>
...
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum.params.create_constraint" title="sqlalchemy.types.Enum"><code class="xref py py-paramref docutils literal"><span class="pre">Enum.create_constraint</span></code></a> flag.</p>
...
<p>The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Boolean" title="sqlalchemy.types.Boolean"><code class="xref py py-class docutils literal"><span class="pre">Boolean</span></code></a> datatype coerces Python booleans to integer values
...
an existing database might not have this constraint.  The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Boolean" title="sqlalchemy.types.Boolean"><code class="xref py py-class docutils literal"><span class="pre">Boolean</span></code></a>
...
within logging, exception reporting, as well as <code class="docutils literal"><span class="pre">repr()</span></code> of the row itself:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">create_engine</span>
...
the core now gains a <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">sqlalchemy.types.JSON</span></code></a> datatype that is the basis
...
<p><a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a></p>
<p><a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSON</span></code></a></p>
<p class="last"><a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal"><span class="pre">mysql.JSON</span></code></a></p>
</div>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/3619">#3619</a></p>
<div class="section" id="json-null-is-inserted-as-expected-with-orm-operations-regardless-of-column-default-present">
<span id="change-3514"></span><h4>JSON &#8220;null&#8221; is inserted as expected with ORM operations, regardless of column default present<a class="headerlink" href="#json-null-is-inserted-as-expected-with-orm-operations-regardless-of-column-default-present" title="Permalink to this headline">¶</a></h4>
<p>The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a> type and its descendant types <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSON</span></code></a>
and <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal"><span class="pre">mysql.JSON</span></code></a> have a flag <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.params.none_as_null" title="sqlalchemy.types.JSON"><code class="xref py py-paramref docutils literal"><span class="pre">types.JSON.none_as_null</span></code></a> which
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">obj</span> <span class="o">=</span> <span class="n">MyObject</span><span class="p">(</span><span class="n">json_value</span><span class="o">=</span><span class="kc">None</span><span class="p">)</span>
...
<span class="n">session</span><span class="o">.</span><span class="n">commit</span><span class="p">()</span>   <span class="c1"># would fire off default / server_default, not encode &quot;&#39;none&#39;&quot;</span></pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span><span class="o">.</span><span class="n">bulk_insert_mappings</span><span class="p">(</span>
    <span class="n">MyObject</span><span class="p">,</span>
    <span class="p">[{</span><span class="s2">&quot;json_value&quot;</span><span class="p">:</span> <span class="kc">None</span><span class="p">}])</span>  <span class="c1"># would insert SQL NULL and/or trigger defaults</span></pre></div>
</div>
<p>The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a> type now implements the
...
automatically based on the value of <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.params.none_as_null" title="sqlalchemy.types.JSON"><code class="xref py py-paramref docutils literal"><span class="pre">types.JSON.none_as_null</span></code></a>.
...
<span class="n">session</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="n">obj</span><span class="p">)</span>
<span class="n">session</span><span class="o">.</span><span class="n">commit</span><span class="p">()</span>   <span class="c1"># *will* fire off column defaults, and/or insert SQL NULL</span></pre></div>
</div>
<p>The feature applies as well to the new base <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a> type
...
of whether a <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a>, <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSON</span></code></a>, <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal"><span class="pre">mysql.JSON</span></code></a>,
or <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSONB</span></code></a> column
should receive a SQL NULL or JSON <code class="docutils literal"><span class="pre">&quot;null&quot;</span></code> value, the constant
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.NULL" title="sqlalchemy.types.JSON.NULL"><code class="xref py py-attr docutils literal"><span class="pre">types.JSON.NULL</span></code></a> has been added, which in conjunction with
...
JSON <code class="docutils literal"><span class="pre">&quot;null&quot;</span></code>, regardless of what <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.params.none_as_null" title="sqlalchemy.types.JSON"><code class="xref py py-paramref docutils literal"><span class="pre">types.JSON.none_as_null</span></code></a> is set
to:</p>
...
<p>Along with the enhancements made to the PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ARRAY</span></code></a>
...
is now in Core.   The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY" title="sqlalchemy.types.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">types.ARRAY</span></code></a> type still <strong>only works on
...
<p>In support of ANY and ALL, the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY" title="sqlalchemy.types.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">types.ARRAY</span></code></a> type retains the same
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY.Comparator.any" title="sqlalchemy.types.ARRAY.Comparator.any"><code class="xref py py-meth docutils literal"><span class="pre">types.ARRAY.Comparator.any()</span></code></a> and <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY.Comparator.all" title="sqlalchemy.types.ARRAY.Comparator.all"><code class="xref py py-meth docutils literal"><span class="pre">types.ARRAY.Comparator.all()</span></code></a> methods
...
as:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">any_</span><span class="p">,</span> <span class="n">all_</span>
...
type directly, which provides all functionality of the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY" title="sqlalchemy.types.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">types.ARRAY</span></code></a>
type as well.</p>
...
<p>With the new <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY" title="sqlalchemy.types.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">types.ARRAY</span></code></a> type we can also implement a pre-typed
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.dialects.postgresql</span> <span class="k">import</span> <span class="n">array_agg</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">department</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">percentile_cont</span><span class="p">(</span><span class="mf">0.5</span><span class="p">)</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># new way</span>
...
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> objects in many schemas, such as schema-per-user, a new
execution option <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection.execution_options.params.schema_translate_map" title="sqlalchemy.engine.Connection.execution_options"><code class="xref py py-paramref docutils literal"><span class="pre">Connection.execution_options.schema_translate_map</span></code></a>
is added.  Using this mapping, a set of <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a>
objects can be made on a per-connection basis to refer to any set of schemas
instead of the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.params.schema" title="sqlalchemy.schema.Table"><code class="xref py py-paramref docutils literal"><span class="pre">Table.schema</span></code></a> to which they were assigned.  The
translation works for DDL and SQL generation, as well as with the ORM.</p>
<p>For example, if the <code class="docutils literal"><span class="pre">User</span></code> class were assigned the schema &#8220;per_user&#8221;:</p>
...
<p>On each request, the <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal"><span class="pre">Session</span></code></a> can be set up to refer to a
different schema each time:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">session</span> <span class="o">=</span> <span class="n">Session</span><span class="p">()</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../core/connections.html#schema-translating"><span class="std std-ref">Translation of Schema Names</span></a></p>
</div>
...
<p>Calling <code class="docutils literal"><span class="pre">str()</span></code> on a Core SQL construct will now produce a string
...
datatypes:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">table</span><span class="p">,</span> <span class="n">column</span>
...
<p>The <code class="docutils literal"><span class="pre">str()</span></code> function now calls upon an entirely separate dialect / compiler
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-3081"><span class="std std-ref">Stringify of Query will consult the Session for the correct dialect</span></a></p>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">StringAsInt</span><span class="p">(</span><span class="n">TypeDecorator</span><span class="p">):</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">person</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">person_id</span><span class="p">,</span> <span class="n">pets_1</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">pets_1_id</span><span class="p">,</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">pets</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">pets_id</span><span class="p">,</span> <span class="n">pets</span><span class="o">.</span><span class="n">person_id</span> <span class="n">AS</span> <span class="n">pets_person_id</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">q</span> <span class="o">=</span> <span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">User</span><span class="o">.</span><span class="n">name</span><span class="o">.</span><span class="n">label</span><span class="p">(</span><span class="s1">&#39;name&#39;</span><span class="p">))</span><span class="o">.</span>\
...
<p>Produces:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">DISTINCT</span> <span class="n">user</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="n">user</span><span class="o">.</span><span class="n">name</span> <span class="n">AS</span> <span class="n">name</span><span class="p">,</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="n">DISTINCT</span> <span class="n">user</span><span class="o">.</span><span class="n">id</span> <span class="n">AS</span> <span class="n">a_id</span><span class="p">,</span> <span class="n">user</span><span class="o">.</span><span class="n">name</span> <span class="n">AS</span> <span class="n">name</span><span class="p">,</span> <span class="n">user</span><span class="o">.</span><span class="n">name</span> <span class="n">AS</span> <span class="n">a_name</span><span class="p">,</span>
  <span class="n">user</span><span class="o">.</span><span class="n">fullname</span> <span class="n">AS</span> <span class="n">a_fullname</span>
<span class="n">FROM</span> <span class="n">a</span> <span class="n">ORDER</span> <span class="n">BY</span> <span class="n">user</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">user</span><span class="o">.</span><span class="n">name</span><span class="p">,</span> <span class="n">user</span><span class="o">.</span><span class="n">fullname</span></pre></div>
</div>
<p>Where above, the <code class="docutils literal"><span class="pre">user.name</span></code> column is added unnecessarily.  The results
...
expressions to <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.distinct" title="sqlalchemy.orm.query.Query.distinct"><code class="xref py py-meth docutils literal"><span class="pre">Query.distinct()</span></code></a>, the above &#8220;column adding&#8221; logic
...
<p>The <a class="reference internal" href="../orm/mapped_attributes.html#sqlalchemy.orm.validates" title="sqlalchemy.orm.validates"><code class="xref py py-func docutils literal"><span class="pre">orm.validates()</span></code></a> decorator is only intended to be created once
...
<p>The new behavior of the <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.TextClause.columns" title="sqlalchemy.sql.expression.TextClause.columns"><code class="xref py py-meth docutils literal"><span class="pre">TextClause.columns()</span></code></a> method, which itself
...
<p>An application that is using this method by passing <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a> objects
to it positionally must ensure that the position of those <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal"><span class="pre">Column</span></code></a>
objects matches the position in which these columns are stated in the
textual SQL.</p>
<p>E.g., code like the following:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">text</span><span class="p">(</span><span class="s2">&quot;SELECT id, name, description FROM table&quot;</span><span class="p">)</span>
...
significant:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># correct version</span>
...
Therefore when using <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.TextClause.columns" title="sqlalchemy.sql.expression.TextClause.columns"><code class="xref py py-meth docutils literal"><span class="pre">TextClause.columns()</span></code></a>, it&#8217;s advised to list out
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-3501"><span class="std std-ref">ResultSet column matching enhancements; positional column setup for textual SQL</span></a></p>
</div>
</div>
...
<p>A server default passed to <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.server_default" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal"><span class="pre">Column.server_default</span></code></a> as a plain
Python string that has quotes embedded is now
passed through the literal quoting system:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy.schema</span> <span class="k">import</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Table</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">CreateTable</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="p">(</span><span class="n">SELECT</span> <span class="n">x</span> <span class="n">FROM</span> <span class="n">table1</span> <span class="n">ORDER</span> <span class="n">BY</span> <span class="n">y</span> <span class="n">LIMIT</span> <span class="mi">1</span><span class="p">)</span> <span class="n">UNION</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt1</span> <span class="o">=</span> <span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Model1</span><span class="p">)</span><span class="o">.</span><span class="n">order_by</span><span class="p">(</span><span class="n">Model1</span><span class="o">.</span><span class="n">y</span><span class="p">)</span><span class="o">.</span><span class="n">limit</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span><span class="o">.</span><span class="n">subquery</span><span class="p">()</span><span class="o">.</span><span class="n">select</span><span class="p">()</span>
...
<p>The <code class="docutils literal"><span class="pre">ON</span> <span class="pre">CONFLICT</span></code> clause of <code class="docutils literal"><span class="pre">INSERT</span></code> added to PostgreSQL as of
version 9.5 is now supported using a PostgreSQL-specific version of the
<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert" title="sqlalchemy.sql.expression.Insert"><code class="xref py py-class docutils literal"><span class="pre">Insert</span></code></a> object, via <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.dml.insert" title="sqlalchemy.dialects.postgresql.dml.insert"><code class="xref py py-func docutils literal"><span class="pre">sqlalchemy.dialects.postgresql.dml.insert()</span></code></a>.
This <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert" title="sqlalchemy.sql.expression.Insert"><code class="xref py py-class docutils literal"><span class="pre">Insert</span></code></a> subclass adds two new methods <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.dml.Insert.on_conflict_do_update" title="sqlalchemy.dialects.postgresql.dml.Insert.on_conflict_do_update"><code class="xref py py-meth docutils literal"><span class="pre">Insert.on_conflict_do_update()</span></code></a>
and <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.dml.Insert.on_conflict_do_nothing" title="sqlalchemy.dialects.postgresql.dml.Insert.on_conflict_do_nothing"><code class="xref py py-meth docutils literal"><span class="pre">Insert.on_conflict_do_nothing()</span></code></a> which implement the full syntax
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">INSERT</span> <span class="n">INTO</span> <span class="n">my_table</span> <span class="p">(</span><span class="nb">id</span><span class="p">,</span> <span class="n">data</span><span class="p">)</span>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/postgresql.html#postgresql-insert-on-conflict"><span class="std std-ref">INSERT...ON CONFLICT (Upsert)</span></a></p>
</div>
...
<p>As described in <a class="reference internal" href="#change-3499"><span class="std std-ref">Changes regarding &#8220;unhashable&#8221; types</span></a>, the ORM relies upon being able to
...
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ARRAY</span></code></a> and <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSON</span></code></a>.
...
types already included this flag.  For <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal"><span class="pre">postgresql.ARRAY</span></code></a>,
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p><a class="reference internal" href="#change-3499"><span class="std std-ref">Changes regarding &#8220;unhashable&#8221; types</span></a></p>
<p class="last"><a class="reference internal" href="#change-3503"><span class="std std-ref">Correct SQL Types are Established from Indexed Access of ARRAY, JSON, HSTORE</span></a></p>
</div>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/3499">#3499</a></p>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">int_expr</span> <span class="o">=</span> <span class="n">col</span><span class="p">[</span><span class="mi">5</span><span class="p">][</span><span class="mi">6</span><span class="p">][</span><span class="mi">7</span><span class="p">]</span>   <span class="c1"># returns an Integer expression object</span></pre></div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">json_expr</span> <span class="o">=</span> <span class="n">json_col</span><span class="p">[</span><span class="s1">&#39;key1&#39;</span><span class="p">][</span><span class="s1">&#39;attr1&#39;</span><span class="p">][</span><span class="mi">5</span><span class="p">]</span></pre></div>
</div>
</li>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-3503-cast"><span class="std std-ref">The JSON cast() operation now requires .astext is called explicitly</span></a></p>
</div>
...
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal"><span class="pre">postgresql.JSONB</span></code></a> no longer implicitly invoke the
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON.Comparator.astext" title="sqlalchemy.dialects.postgresql.JSON.Comparator.astext"><code class="xref py py-attr docutils literal"><span class="pre">postgresql.JSON.Comparator.astext</span></code></a> modifier; PostgreSQL&#8217;s JSON/JSONB types
...
as expected:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">enum</span> <span class="o">=</span> <span class="n">Enum</span><span class="p">(</span>
...
<p>emits:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TYPE</span> <span class="n">work_place_roles</span> <span class="n">AS</span> <span class="n">ENUM</span> <span class="p">(</span>
...
both within the method <a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector.get_check_constraints" title="sqlalchemy.engine.reflection.Inspector.get_check_constraints"><code class="xref py py-meth docutils literal"><span class="pre">Inspector.get_check_constraints()</span></code></a> as well
as within <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> reflection within the <code class="xref py py-attr docutils literal"><span class="pre">Table.constraints</span></code>
collection.</p>
</div>
...
<p>The <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal"><span class="pre">Index</span></code></a> object now accepts the argument <code class="docutils literal"><span class="pre">postgresql_tablespace</span></code>
in order to specify TABLESPACE, the same way as accepted by the
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> object.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/postgresql.html#postgresql-index-storage"><span class="std std-ref">Index Storage Parameters</span></a></p>
</div>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/postgresql.html#dialect-postgresql-pygresql"><span class="std std-ref">pygresql</span></a></p>
</div>
</div>
...
<p>The <code class="docutils literal"><span class="pre">sqlalchemy.dialects.postgres</span></code> module, long deprecated, is
...
<p>The new parameters <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.GenerativeSelect.with_for_update.params.skip_locked" title="sqlalchemy.sql.expression.GenerativeSelect.with_for_update"><code class="xref py py-paramref docutils literal"><span class="pre">GenerativeSelect.with_for_update.skip_locked</span></code></a>
and <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.GenerativeSelect.with_for_update.params.key_share" title="sqlalchemy.sql.expression.GenerativeSelect.with_for_update"><code class="xref py py-paramref docutils literal"><span class="pre">GenerativeSelect.with_for_update.key_share</span></code></a>
in both Core and ORM apply a modification to a &#8220;SELECT...FOR UPDATE&#8221;
or &#8220;SELECT...FOR SHARE&#8221; query on the PostgreSQL backend:</p>
<ul>
<li><p class="first">SELECT FOR NO KEY UPDATE:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="n">table</span><span class="p">])</span><span class="o">.</span><span class="n">with_for_update</span><span class="p">(</span><span class="n">key_share</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span></pre></div>
</div>
</li>
<li><p class="first">SELECT FOR UPDATE SKIP LOCKED:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">stmt</span> <span class="o">=</span> <span class="n">select</span><span class="p">([</span><span class="n">table</span><span class="p">])</span><span class="o">.</span><span class="n">with_for_update</span><span class="p">(</span><span class="n">skip_locked</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span></pre></div>
</div>
</li>
<li><p class="first">SELECT FOR KEY SHARE:</p>
...
<p>A new type <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal"><span class="pre">mysql.JSON</span></code></a> is added to the MySQL dialect supporting
the JSON type newly added to MySQL 5.7.   This type provides both persistence
of JSON as well as rudimentary indexed-access using the <code class="docutils literal"><span class="pre">JSON_EXTRACT</span></code>
function internally.  An indexable JSON column that works across MySQL
and PostgreSQL can be achieved by using the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal"><span class="pre">types.JSON</span></code></a> datatype
common to both MySQL and PostgreSQL.</p>
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="#change-3619"><span class="std std-ref">JSON support added to Core</span></a></p>
</div>
...
<a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine.params.isolation_level" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal"><span class="pre">create_engine.isolation_level</span></code></a> and
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">some_table</span> <span class="p">(</span>
...
use the <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.PrimaryKeyConstraint" title="sqlalchemy.schema.PrimaryKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">PrimaryKeyConstraint</span></code></a> construct explicitly (1.1.0b2)
...
column name with a dot in it is actually a <code class="docutils literal"><span class="pre">tablename.columnname</span></code> combination
delivered via this buggy behavior, with an option to turn it off via the
<code class="docutils literal"><span class="pre">sqlite_raw_colnames</span></code> execution option.</p>
...
<p>Overall, the SQLAlchemy <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal"><span class="pre">ResultProxy</span></code></a> as of the 1.0 series relies much
...
<p>The <a class="reference internal" href="../core/reflection.html#sqlalchemy.engine.reflection.Inspector" title="sqlalchemy.engine.reflection.Inspector"><code class="xref py py-class docutils literal"><span class="pre">Inspector</span></code></a> will now include ON DELETE and ON UPDATE
phrases from foreign key constraints on the SQLite dialect, and the
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">ForeignKeyConstraint</span></code></a> object as reflected as part of a
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal"><span class="pre">Table</span></code></a> will also indicate these phrases.</p>
</div>
</div>
...
via the <a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine.params.isolation_level" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal"><span class="pre">create_engine.isolation_level</span></code></a> and
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection.execution_options.params.isolation_level" title="sqlalchemy.engine.Connection.execution_options"><code class="xref py py-paramref docutils literal"><span class="pre">Connection.execution_options.isolation_level</span></code></a>
parameters.  The four standard levels are supported as well as
<code class="docutils literal"><span class="pre">SNAPSHOT</span></code>:</p>
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/mssql.html#mssql-isolation-level"><span class="std std-ref">Transaction Isolation Level</span></a></p>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">create_engine</span><span class="p">,</span> <span class="n">inspect</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">for</span> <span class="n">col</span> <span class="ow">in</span> <span class="n">insp</span><span class="o">.</span><span class="n">get_columns</span><span class="p">(</span><span class="s2">&quot;s&quot;</span><span class="p">):</span>
<span class="gp">... </span>    <span class="nb">print</span><span class="p">(</span><span class="n">col</span><span class="p">[</span><span class="s1">&#39;type&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">__class__</span><span class="p">,</span> <span class="n">col</span><span class="p">[</span><span class="s1">&#39;type&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">length</span><span class="p">)</span>
<span class="gp">...</span>
...
<p>The <code class="docutils literal"><span class="pre">mssql_clustered</span></code> flag available on <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.UniqueConstraint" title="sqlalchemy.schema.UniqueConstraint"><code class="xref py py-class docutils literal"><span class="pre">UniqueConstraint</span></code></a>,
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.PrimaryKeyConstraint" title="sqlalchemy.schema.PrimaryKeyConstraint"><code class="xref py py-class docutils literal"><span class="pre">PrimaryKeyConstraint</span></code></a>, <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal"><span class="pre">Index</span></code></a> now defaults to <code class="docutils literal"><span class="pre">None</span></code>, and
...
<div class="admonition seealso">
<p class="first admonition-title">See also</p>
<p class="last"><a class="reference internal" href="../dialects/mssql.html#mssql-indexes"><span class="std std-ref">Clustered Index Support</span></a></p>
</div>
</div>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">account_table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">eng</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;mssql+pymssql://mydsn&quot;</span><span class="p">,</span> <span class="n">legacy_schema_aliasing</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
